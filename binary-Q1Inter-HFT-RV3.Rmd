...
日内指数平滑数据2016年结论 <- 总汇结论(文件名 = '日内指数平滑数据2016年', 是否储存结论 = '是')
日内指数平滑数据2017年结论 <- 总汇结论(文件名 = '日内指数平滑数据2017年', 是否储存结论 = '是')
日内指数平滑数据2018年结论 <- 总汇结论(文件名 = '日内指数平滑数据2018年', 是否储存结论 = '是')
日内指数平滑数据2018年上半年结论 <- 总汇结论(文件名 = '日内指数平滑数据2018年上半年', 是否储存结论 = '是')
```
