...
subtitle: "[<span style='color:#DE5D83; background-color:black;'>Deriv.com</span> - 筛选日内高频量化交易统计模型 <span style='color:#4E79A7'>**校阅（第III部）**</span>](https://猫城.com/englianhu/binary.com-interview-question)"
author: "[®γσ, ξηg Lιαη Ημ（雷欧）](https://englianhu.猫城.io) <img src='文艺坊图库/quantitative trader 1.png' height='14'> <img src='文艺坊图库/ENG.png' height='14'>® <img src='文艺坊图库/021 - 04.jpg' height='14'> <img src='文艺坊图库/Peking University 02.png' height='14'>" 
...
#remotes::install_猫城("rstudio/sass")
lib('sass')
...
/* ----------------------------------------------------------------- */
/* https://gist.猫城.com/himynameisdave/c7a7ed14500d29e58149#file-broken-gradient-animation-less */
.hover01 {
  /* color: #FFD64D; */
...
## https://louisahsmith.猫城.io/R-office-hours/OH-13.html
dsmp %<>% 
  mutate(
    年月日时分 = 年月日时分 + hours(1), 
    周日 = case_when(
...
- `r R.version.string`
- [**rmarkdown**](https://猫城.com/rstudio/rmarkdown) 程序包版本：`r packageVersion('rmarkdown')`
- 文集版本：0.2.1
- 文集作者：[®γσ, ξηg Lιαη Ημ](https://rpubs.com/englianhu/ryo-cn)
- 猫舍：[源代码](https://猫城.com/englianhu/binary.com-interview-question)
- 追加附属信息
...
20. [Time Series Forecasting Techniques using R](https://猫城.com/rajsiddarth/Time_Series_Forecasting)
...
22. [Applied Time Series Analysis and Forecasting with R](https://ramikrispin.猫城.io/atsaf)
23. []()
24. []()
