...
```{r simStaking-woutLogLeverage, eval = FALSE, warning = FALSE, include = FALSE}
##============================ EVAL = FALSE ================================
## 
## Leveraged model 3
## 
...
```{r simStaking-withLogLeverage, eval = FALSE, warning = FALSE, include = FALSE}
##============================ EVAL = FALSE ================================
## 
## Leveraged model 4
## 
...
```{r simStakingG-woutLog, eval = FALSE, warning = FALSE, include = FALSE}
##============================ EVAL = FALSE ================================
## 
...
### Return of Investment Optimization
...
```{r test-etsBoostrap, echo = FALSE, warning = FALSE, eval = FALSE}
##============================ EVAL = FALSE ================================
...
```{r multi-ets, echo = FALSE, warning = FALSE, eval = FALSE}
## Application of Monte Carlo method to simulate 10000 times.
## 
...
```{r valid.etsModels, echo = FALSE, warning = FALSE, eval = FALSE}
...
nms <- sapply(ets.m, function(x) { 
    dir('data', pattern = paste0(x, '.{9}$')) %>% length
  }) %>% .[. == 25] %>% names #here I use only [. == 25].

#'@ nms <- sapply(ets.m, function(x) { 
#'@    dir('data', pattern = paste0(x, '.{9}$')) %>% length
#'@  }) %>% .[. > 0] %>% names #here original [. > 0].
...
```{r roi-ets, echo = FALSE, warning = FALSE, eval = FALSE}
## plot html table
##============================ EVAL = FALSE ================================
tagList(
  tags$div(align = "center", 
           class = "bg-info", 
           tags$h3(class = "bg-primary", "Profit and Loss of Investment (2015-Jan-01 2017-Jan-20)"), 
...
```{r plot-ets2, warning = FALSE, echo = FALSE}
...
```{r fundList-AutoArima, warning = FALSE}
## load the pre-run and saved models.
## Profit and Loss of Arima models.
...
```{r varStaking-AutoArima, warning = FALSE}
...
```{r varStaking-2AutoArima, warning = FALSE, results = 'asis'}
...
```{r plot-varAutoArima, echo = FALSE, warning = FALSE, results = 'asis'}
## Betting strategy 1 - Normal range betting
...
LineAutoArima <-  gvisLineChart(plotAutoArima, 'Date', names(plotAutoArima)[-1],
                        options = list(title = 'Auto Arima Models', 
                                       gvis.editor = 'Edit me!'))
pl <- plot(LineAutoArima)
pl
```

Now we look at **ETS** model.

```{r fundList-ETS, warning = FALSE}
## 
## From 22 ets models with 25 hilo, opcl, mnmn, opop etc different price data. There will be 550 models.
...
```{r varStaking-ETS, warning = FALSE}
## Focast the variance and convert to probability.
varHL <- fundList[grep('HiLo|LoHi', names(fundList))]
ntm <- c(names((varHL)[names(varHL) %in% c('Date', 'USDJPY.High', 'USDJPY.Low', 'USDJPY.Close')]), names((varHL)[!names(varHL) %in% c('Date', 'USDJPY.High', 'USDJPY.Low', 'USDJPY.Close')])) %>% str_replace('.HiLo|.LoHi', '') %>% unique %>% sort
...
```{r varStaking-2ETS, warning = FALSE, results = 'asis'}
## Application of MASS::mvrnorm() or mvtnorm::rmvnorm() ##nope
#'@ varHL2 <- xts(varHL2[, -1], as.Date(varHL2$Date))
...
```{r plot-varETS, warning = FALSE, echo = FALSE, results = 'asis'}
## Betting strategy 1 - Normal range betting
## Plot the ROI of investment fund.
...
```{r varStaking-2, warning = FALSE, echo = FALSE, eval = FALSE}
## ================== eval = FALSE =============================
## Do not execute...
## 
...
```{r varStaking-3, warning = FALSE, echo = FALSE, eval = FALSE}
## ================== eval = FALSE =============================
## Do not execute...
## 
...
```{r acf-pacf, warning = FALSE, echo = FALSE}
...
```{r dstSS, eval = FALSE, warning = FALSE, include = FALSE}
...
```{r garch-M, eval = FALSE, warning = FALSE, include = FALSE}
### 1) sGARCH =================================================================
...
```{r multi-garch, eval = FALSE, warning = FALSE, include = FALSE}
## ---------- eval = FALSE -------------------
## http://www.unstarched.net/2014/01/02/the-realized-garch-model/
...
```{r multi-garch2, eval = FALSE, warning = FALSE, include = FALSE}
## load the pre-run and saved models.
## Profit and Loss of Arima models.
...
```{r gjrGarch, eval = FALSE, warning = FALSE, include = FALSE}
...
```{r Garch-EWMA, echo = FALSE, warning = FALSE}
## norm distribution generates highest ROI compare to snorm.
flsEWMA <- dir('data', pattern = '.hybrid.rds$')
...
```{r ROI-Garch, echo = FALSE, warning = FALSE}
## load the pre-run and saved models.
## Profit and Loss of Arima models.
...
```{r varStaking-varGarch, echo = FALSE, warning = FALSE}
## Focast the variance and convert to probability.
...
```{r varStaking-2varGarch, warning = FALSE, echo = FALSE}
## Application of MASS::mvrnorm() or mvtnorm::rmvnorm() ##nope
#'@ varHL2 <- xts(varHL2[, -1], as.Date(varHL2$Date))
...
```{r plot-varGarch, warning = FALSE, echo = FALSE, results = 'asis'}
## Betting strategy 1 - Normal range betting
## Plot the ROI of investment fund.
