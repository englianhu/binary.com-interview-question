...
subtitle: "[<span style='color:#DE5D83; background-color:black;'>Deriv.com</span> - Interday High Frequency Trading Models Comparison <span style='color:#4E79A7'>**Review (Part I)**</span>](https://github.com/englianhu/binary.com-interview-question)"
...
## data_m1 <- read_rds('/home/englianhu/Documents/GitHub/real-time-fxcm/data/USDJPY/data_m1.rds')
...
```{r, include = FALSE}
if(exists('data_abn')) rm(data_abn)
```
...
if(!exists('.dtr')) {
  ## .dtr <- '/home/englianhu/GitHub/binary.com-interview-question-data/'
  .dtr <- 'C:/Users/User/Documents/GitHub/binary.com-interview-question-data/'}
