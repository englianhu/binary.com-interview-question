...
## Due to files size more than 1GB and over 0.1 billion observation, here I save into 3 files.

```

```{r message=FALSE, warning=FALSE}
mds_ts <- read_rds('data/fx/USDJPY/mds_ts.rds')
mds_ets_AAN_MAZ <- read_rds('data/fx/USDJPY/mds_ets_AAN_MAZ.rds')
mds_ets_MMN_ZAN <- read_rds('data/fx/USDJPY/mds_ets_MMN_ZAN.rds')
mds_ets_ZAZ_ZZZ <- read_rds('data/fx/USDJPY/mds_ets_ZAZ_ZZZ.rds')
```
