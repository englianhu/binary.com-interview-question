...
*数据 : `r 样本二零一八半年 <- readRDS('/home/englianhu/文档/猫城/binary.com-interview-question-data/诸子百家学府/fx/USDJPY/样本2018半年.rds'); paste0(num2c(dim(样本二零一八半年)[1], lang = 'sc'), '行 乘 ', num2c(dim(样本二零一八半年)[2], lang = 'sc'), '列')`*
