...
| 时辰 | 雅称 |         其它雅称 |             十二时辰对照 |
|:----:|:----:|:----------------:|:------------------------:|
| 子时 | 夜半 |             子夜 | 夜晚十一点至午夜  一点钟 |
| 丑时 | 鸡鸣 |             荒鸡 | 午夜  一点至凌晨  三点钟 |
| 寅时 | 平旦 | 黎明、早晨、日旦 | 凌晨  三点至黎明  五点钟 |
| 卯时 | 日出 | 日始、破晓、旭日 | 黎明  五点至早晨  七点钟 |
| 辰时 | 食时 |       早食、朝食 | 早晨  七点至上午  九点钟 |
| 巳时 | 隅中 |             日隅 | 上午  九点至上午十一点钟 |
| 午时 | 日中 |       日正、中午 | 上午十一点至中午  一点钟 |
| 未时 | 日跌 |             日央 | 中午  一点至下午  三点钟 |
| 申时 | 晡时 |       日铺、夕食 | 下午  三点至下午  五点钟 |
| 酉时 | 日入 | 日落、日沉、傍晚 | 下午  五点至傍晚  七点钟 |
| 戌时 | 黄昏 | 日夕、日暮、日晚 | 傍晚  七点至黄昏  九点钟 |
| 亥时 | 人定 |             定昏 | 黄昏  九点至夜晚十一点钟 |
...
此外，将此文献（第IV部）改为使用咱们道家天干中的甲乙丙丁中的（丁），丙且添加天文历法、天干地支、廿四节气、农历月份雅称等参数计算周期。
...
*数据 : `r paste0(num2c(dim(样本2018半年)[1], lang = 'sc'), '行 乘 ', num2c(dim(样本2018半年)[2], lang = 'sc'), '列')`*
