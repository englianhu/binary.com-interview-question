...
*引用：[「栈溢出」arima function summary returns In training accuracy(object, test, d, D) : test elements must be within sample](https://stackoverflow.com/a/70911018/3806250)*
...
- [「栈溢出」arima function summary returns In training accuracy(object, test, d, D) : test elements must be within sample](https://stackoverflow.com/a/70911018/3806250)
