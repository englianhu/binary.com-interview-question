...
conflict_prefer('nth', 'dplyr', quiet = TRUE)
...
程序包 <- c(
  ...
  'tidyft', 'quantmod', 'tidyquant', 'tibbletime', 'timetk', 'plyr', 'dplyr', 
...
汇总2018年 <- 样本 %>% 
  filter(年月日时分 >= as_datetime('2018-01-02 12:00:00') & 
           年月日时分 <= as_datetime('2018-07-01 00:00:00'))
