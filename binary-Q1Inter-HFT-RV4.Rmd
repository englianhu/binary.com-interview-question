...
*引用：[「汤普勒」时间序例之贝式隐马尔可夫链（附学术参考书）](https://www.tumblr.com/blog/view/englianhu/641578918656212992?source=share)*
...
> 古代的更是按时间算的，旧时打梆子或敲锣巡夜报时（一夜分为五更，每更约两小时）。<br>
> 
> - 傍晚  七点钟 至 黄昏  九点钟：为戌时一更，天干物燥，小心火烛；<br>
- 黄昏  九点钟 至 夜晚十一点钟：为亥时二更，关门关窗，防偷防盗；<br>
- 夜晚十一点钟 至 午夜  一点钟：为子时三更，平安无事；<br>
- 午夜  一点钟 至 凌晨  三点钟：为丑时四更，天寒地冻；<br>
- 凌晨  三点钟 至 黎明  五点钟：为寅时五更，早睡早起，保重身体。<br><br>
*注：此处「更」在古汉语中读「jing」。*
...
[<span style='color:#DE5D83; background-color:black;'>*Deriv.com*</span> - *Interday High Frequency Trading Models Comparison* <span style='color:RoyalBlue'>*Review (Part II)*</span>](https://rpubs.com/englianhu/742275)中，结论千皕分钟为最优数据量，故此我将数据量设置为(千皕分钟，也就是等于20个交易小时)，去预测下一分钟交易价格。然而如何灵活设置周期量与周期数、运用循环周期呢？在此尝试回测方能得以证实。
