...
- <span style='color:red'>However it will be more easily since the settled price will be only daily closed price. Here I will tune a bit the coding and also add normal Kelly criterion model for comparison. Therefore the ROI for both financial betting and also normal trading market will be shown in this paper.</span>
- <span style='color:red'>The ONLY objective is made the research applicable to real-life in order to write a real-trading system byond the future.</span>
