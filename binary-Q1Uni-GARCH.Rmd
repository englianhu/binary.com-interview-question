...
All my previous papers applied Markov theory which is $p(x_{n}|x_{n-1}...x_{1})$, here I try to test if the model maximised the likelihood of occurance. Here I iteration 100 times.
...
```{r read-models, warning=FALSE, message=FALSE}
...
united.dateID <- ldply(mdate, count, 'date') %>% tbl_df %>% 
  ...
  spread(.id, freq) %>% 
  filter(sGARCH == 7 & fGARCH.GARCH == 7 & fGARCH.TGARCH == 7 & 
...
## check completed dataset.
mdate <- dplyr::count(fx, Date, Type) %>% tbl_df

##filter 7 currency and OHLC data.
united.dateID <- mdate %>% dplyr::filter(n == 14) %>% .$Date %>% unique
...
05. [41901 Probability and Statistics](41901 Probability and Statistics.pdf)
06. [A Comparison of Volatility Models - Does Anything Beat a GARCH(1,1)]()
07. [A Winners Curse for Econometric Models - On the Joint Distribution of In-Sample Fit and Out-of-Sample Fit and Its Implications for Model Selection]()
08. [AMATH546 - ECON589 HW3]()
09. [ARMA(1,1)-GARCH(1,1) Estimation and Forecast using rugarch 1.2-2]()
10. [Creating Optimal Portfolios of Stocks with Time-Varying Risk]()
11. [Dynamic Portfolio Optimization using Generalized Dynamic Conditoinal Heteroskedastic Factor Models]()
12. [EGARCH, GKR-GARCH, TGARCH, AVGARCH, NGARCH, IGARCH and APARCH Models for Pathogens at Marine Recreational Sites]()
13. [Enhancing Trading Strategies with Order Book Signals]()
14. [GARCH Models in Value at Risk Estimation Empirical Evidence from Montenegrin Stock Exchange]()
15. [How Does the Fortune's Formula-Kelly Capital Growth Model Perform]()
16. [Information Theory and Gambling or Economics]()
17. [Investment Portfolio Optimization with GARCH Models]()
18. [Kelly Criterion Revisited - Optimal Bets]()
19. [Markov-Switching Autoregressive Models for Wind Times Series (ppt)]()
20. [Markov-Switching Autoregressive Models for Wind Times Series]()
21. [Medium Term Simulations of the Full Kelly and Fractional]()
22. [Modelling Exchange Rates using Regime Switching Models]()
23. [Money Management (V1)]()
24. [Money Management (V2)]()
25. [Optimal Betting under Parameter Uncertainty - Improving the Kelly Criterion]()
26. [Predicting Stock Price Returns using Garch Model]()
27. [Predicting Accuracy of GARCH, GJR and EGARCH Models Select Exchange Rates Application]()
28. [Stochastic Modelling and Optimization Methods in Investments]()
29. [The Kelly Criterion - Implementation, Simulation and Backtest]()
30. [The Kelly Criterion and Bet Comparison in Spread Betting]()
31. [The Kelly Criterion for Spread Bets]()
32. [The Market for English Premier League (EPL) Odds]()
33. [Valuation of Soccer Spread Bets]()
34. [Which GARCH Model is Best for Value-at-Risk]()
