...
subtitle: "[<span style='color:blue'>binary.com</span>](https://github.com/englianhu/binary.com-interview-question) Interview Question (lite version answer)"
...
pkgs <- c('knitr', 'kableExtra', 'tint', 'devtools', 'lubridate', 'plyr', 'stringr', 'magrittr', 'dplyr', 'tidyr', 'turner', 'readr', 'tidyverse', 'quantmod', 'tidyquant', 'htmltools', 'highcharter', 'googleVis', 'formattable', 'DT', 'forecast', 'Mcomp', 'bsts', 'MCMCpack', 'PerformanceAnalytics', 'broom', 'microbenchmark', 'doParallel', 'Boruta', 'rugarch', 'parma', 'rmgarch')
...
#### 2.1.2.2 Garch vs EWMA
  ...
  - [<span style='color:blue'>Introduction to some R package</span>](./reference/IntroPackages.pdf)
  - [<span style='color:blue'>Introduction to the ruGarch package</span>](./reference/Introduction_to_the_rugarch_package.pdf)
  - [<span style='color:blue'>The rmgarch models: Background and properties. - R Project</span>](./reference/The_rmgarch_models.pdf)
...
```{r simStaking-woutLog, eval = FALSE}
##============================ EVAL = FALSE ================================
## 
...
#        Date AAN.Bal AAZ.Bal ANN.Bal ANZ.Bal AZN.Bal AZZ.Bal MAN.Bal MAZ.Bal MMN.Bal MMZ.Bal MNN.Bal
#530 2017-01-13    2800    2800    -200    -200    -200    -200    3600    3600    3000    3000     200
#531 2017-01-16    2700    2700    -300    -300    -300    -300    3500    3500    2900    2900     100
#532 2017-01-17    2800    2800    -200    -200    -200    -200    3600    3600    3000    3000     200
#533 2017-01-18    2700    2700    -300    -300    -300    -300    3500    3500    2900    2900     100
#534 2017-01-19    2800    2800    -200    -200    -200    -200    3600    3600    3000    3000     200
#535 2017-01-20    2700    2700    -300    -300    -300    -300    3500    3500    2900    2900     100
#    MNZ.Bal MZN.Bal MZZ.Bal ZAN.Bal ZAZ.Bal ZMN.Bal ZMZ.Bal ZNN.Bal ZNZ.Bal ZZN.Bal ZZZ.Bal
#530     200    2000    2000    3200    3200    3000    3000    -200    -200    1200    1200
#531     100    1900    1900    3100    3100    2900    2900    -300    -300    1100    1100
#532     200    2000    2000    3200    3200    3000    3000    -200    -200    1200    1200
#533     100    1900    1900    3100    3100    2900    2900    -300    -300    1100    1100
#534     200    2000    2000    3200    3200    3000    3000    -200    -200    1200    1200
#535     100    1900    1900    3100    3100    2900    2900    -300    -300    1100    1100
```
...
<span style='color:blue'>*It doesn't work since thhe closed price* **MUST** *be between highest and lowest price. Here I stop it and set as `eval = FALSE` for display purpose but not execute*</span>

```{r variance-staking2, eval = FALSE}
## ================== eval = FALSE =============================
## Do not execute...
## 
...
```{r variance-staking3, eval = FALSE}
## ================== eval = FALSE =============================
## Do not execute...
## 
