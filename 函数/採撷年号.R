採撷年号 <- function(天朝 = NULL, 进度 = '叉') {
  ...
  if (unique(年号通史$农历干支) == '农历干支') 年号通史$农历干支 <- NULL
  if (unique(年号通史$十二生肖) == '生肖') 年号通史$十二生肖 <- NULL
  if (unique(年号通史$朝代) == '朝代') 年号通史$朝代 <- NULL
  if (unique(年号通史$在位皇帝) == '在位皇帝') 年号通史$在位皇帝 <- NULL
  if (unique(年号通史$年号) == '年号') 年号通史$年号 <- NULL
