...
timeID <- HiLo.base %>% 
  ...
  .[. >= timeID0] %>% 
  c(., xts::last(.) + days(1))
tmID <- list.files('data/fx/USDJPY', pattern = '^DCC.GARCH.USDJPY.HL.') %>% 
...
timeID <- HiLo.base %>% 
  ...
  .[. >= timeID0] %>% 
  c(., xts::last(.) + days(1))
tmID <- list.files('data/fx/USDJPY', pattern = '^aDCC.GARCH.USDJPY.HL.') %>% 
  str_extract_all('[0-9]{4}-[0-9]{2}-[0-9]{2}') %>% 
  unlist %>% ymd
...
timeID <- HiLo.base %>% 
  ...
  .[. >= timeID0] %>% 
  c(., xts::last(.) + days(1))
tmID <- list.files('data/fx/USDJPY', pattern = '^FDCC.GARCH.USDJPY.HL.') %>% 
  str_extract_all('[0-9]{4}-[0-9]{2}-[0-9]{2}') %>% 
  unlist %>% ymd
...
```{r DCC-HLCVARF, message=FALSE, warning=FALSE, eval=FALSE, echo=FALSE}
## ------------- Simulate mv_fx() ----------------------
## mv_fx just made the model and some argument flexible.
md <- c('DCC', 'aDCC', 'FDCC')
sv <- c('solnp')#, 'gosolnp')
...
tmID <- list.files('data/fx/USDJPY', pattern = '^DCC.GARCH.USDJPY.HLC.') %>% 
  str_extract_all('[0-9]{4}-[0-9]{2}-[0-9]{2}') %>% 
  unlist %>% ymd
...
```{r aDCC-HLCVARF, message=FALSE, warning=FALSE, eval=FALSE, echo=FALSE}
## ------------- Simulate mv_fx() ----------------------
## mv_fx just made the model and some argument flexible.
md <- c('DCC', 'aDCC', 'FDCC')
sv <- c('solnp')#, 'gosolnp')
...
tmID <- list.files('data/fx/USDJPY', pattern = '^aDCC.GARCH.USDJPY.HLC.') %>% 
  str_extract_all('[0-9]{4}-[0-9]{2}-[0-9]{2}') %>% 
  unlist %>% ymd
...
```{r FDCC-HLCVARF, message=FALSE, warning=FALSE, eval=FALSE, echo=FALSE}
## ------------- Simulate mv_fx() ----------------------
## mv_fx just made the model and some argument flexible.
md <- c('DCC', 'aDCC', 'FDCC')
sv <- c('solnp')#, 'gosolnp')
...
tmID <- list.files('data/fx/USDJPY', pattern = '^FDCC.GARCH.USDJPY.HLC.') %>% 
  str_extract_all('[0-9]{4}-[0-9]{2}-[0-9]{2}') %>% 
  unlist %>% ymd
...
tmID <- list.files('data/fx/USDJPY', pattern = '^DCC.GARCH.C.') %>% 
  str_extract_all('[0-9]{4}-[0-9]{2}-[0-9]{2}') %>% 
  unlist %>% ymd
...
tmID <- list.files('data/fx/USDJPY', pattern = '^aDCC.GARCH.C.') %>% 
  str_extract_all('[0-9]{4}-[0-9]{2}-[0-9]{2}') %>% 
  unlist %>% ymd
...
tmID <- list.files('data/fx/USDJPY', pattern = '^FDCC.GARCH.C.') %>% 
  str_extract_all('[0-9]{4}-[0-9]{2}-[0-9]{2}') %>% 
  unlist %>% ymd
...
```{r goGARCH-HLCF, message=FALSE, warning=FALSE, eval=FALSE, echo=FALSE}
## ------------- Simulate mv_fx() ----------------------
## mv_fx just made the model and some argument flexible.
...
timeID <- HiLo.base %>% 
  ...
  .[. >= timeID0] %>% 
  c(., xts::last(.) + days(1))
tmID <- list.files('data/fx/USDJPY', pattern = '^goGARCH.USDJPY.HL.constant.') %>% 
  str_extract_all('[0-9]{4}-[0-9]{2}-[0-9]{2}') %>% 
  unlist %>% ymd
...
```{r goGARCH-HLARF, message=FALSE, warning=FALSE, eval=FALSE, echo=FALSE}
## ------------- Simulate mv_fx() ----------------------
## mv_fx just made the model and some argument flexible.
.dist.models <- c('mvnorm', 'manig', 'magh') #using default mvnorm
md <- c('constant', 'AR', 'VAR')
...
timeID <- HiLo.base %>% 
  ...
  .[. >= timeID0] %>% 
  c(., xts::last(.) + days(1))
tmID <- list.files('data/fx/USDJPY', pattern = '^goGARCH.USDJPY.HL.AR.') %>% 
  str_extract_all('[0-9]{4}-[0-9]{2}-[0-9]{2}') %>% 
  unlist %>% ymd
...
```{r goGARCH-HLVARF, message=FALSE, warning=FALSE, eval=FALSE, echo=FALSE}
## ------------- Simulate mv_fx() ----------------------
## mv_fx just made the model and some argument flexible.
.dist.models <- c('mvnorm', 'manig', 'magh') #using default mvnorm
md <- c('constant', 'AR', 'VAR')
...
timeID <- HiLo.base %>% 
  ...
  .[. >= timeID0] %>% 
  c(., xts::last(.) + days(1))
tmID <- list.files('data/fx/USDJPY', pattern = '^goGARCH.USDJPY.HL.VAR.') %>% 
  str_extract_all('[0-9]{4}-[0-9]{2}-[0-9]{2}') %>% 
  unlist %>% ymd
...
```{r goGARCH-HLcompare}
fls <- list.files('data/fx/USDJPY', pattern = 'goGARCH.USDJPY.HL.')
...
```{r DCC-HLCcompare}
fls <- list.files('data/fx/USDJPY', pattern = 'DCC.GARCH.USDJPY.HLC.')
