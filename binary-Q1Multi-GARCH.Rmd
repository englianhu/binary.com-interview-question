...
pkgs <- c('knitr', 'kableExtra', 'tint', 'devtools', 'lubridate', 'data.table', 'quantmod', 'tidyquant', 'plyr', 'stringr', 'magrittr', 'dplyr', 'tidyverse', 'rlist', 'memoise', 'htmltools', 'highcharter', 'googleVis', 'formattable', 'DT', 'rugarch', 'ccgarch', 'mgarchBEKK', 'rmgarch', 'mfGARCH')
...
Multivariate GARCH models including DCC, GO-GARCH and Copula-GARCH, CCC and BEKK.
...
12. [Comparison of BEKK GARCH and DCC GARCH Models - An Empirical Study]()
13. [Do We Really Need Both BEKK and DCC - A Tale of Two Multivariate GARCH Models]()
14. [Forecasting Conditional Correlation for Exchange Rates using Multivariate GARCH Models with Historical Value-at-Risk Application]()
15. [Volatility Spillover and Time-Varying Conditional Correlation between the European and US Stock Markets]()
16. [Applying MGARCH Models in Finance]()
17. [Comparison of Multivariate GARCH Models with Application to Zero-Coupon Bond Volatility]()
18. [Forecasting the Daily Dynamic Hedge Ratios by GARCH Models - Evidence from the Agricultural Futures Markets]()
