...
```{r DCC-HLVARF, message=FALSE, warning=FALSE, eval=FALSE, echo=FALSE}
## ------------- Simulate mv_fx() ----------------------
...
timeID <- HiLo.base %>% index %>% .[. >= timeID0]

#data/fx/USDJPY/DCC.GARCH.USDJPY.2013-02-01.rds saved!
#DCC.HL.solnp error.
#Error in DCC.GARCH.USDJPY[[i]] : subscript out of bounds
#tmID <- c('2013-02-04', '2013-02-05', '2013-02-25', '2013-03-20', '2013-04-14', 
#  '2013-04-15', '2013-04-22', '2013-04-23', '2013-04-24', '2014-06-16', 
#  '2014-10-28', '2014-12-22', '2017-04-19', '2017-04-20', '2017-04-21', 
#  '2017-04-22', '2017-05-17', '2017-05-18', '2017-05-19', '2017-05-20') %>% 
#  ymd
timeID %<>% .[. > ymd('2017-07-13')]
  ...
  for (i in seq(cr_code[7])) {
    ...
    if (dt %in% timeID2) {
      ...
      saveRDS(DCC.GARCH.USDJPY[[i]], paste0(
        'data/fx/', subdir, '/DCC.GARCH.USDJPY.', 
...
```{r aDCC-HLVARF, message=FALSE, warning=FALSE, eval=FALSE, echo=FALSE}
## ------------- Simulate mv_fx() ----------------------
## mv_fx just made the model and some argument flexible.
## Multivariate models.
md <- c('DCC', 'aDCC', 'FDCC')
...
#data/fx/USDJPY/aDCC.GARCH.USDJPY.2013-01-14.rds saved!
#aDCC.HL.solnp error.
#Error in aDCC.GARCH.USDJPY[[i]] : subscript out of bounds
#tmID <- c('2013-02-04', '2013-02-05', 
#          '2013-04-23', '2013-04-24', '2014-10-28', '2017-04-20', 
#          '2017-04-21', '2017-04-22', '2017-05-17', '2017-05-18', '2017-05-19', 
#          '2017-05-20') %>% 
#  ymd
#timeID %<>% .[. > ymd('2017-05-21')]
#timeID %<>% .[-1]
  ...
  for (i in seq(cr_code[7])) {
    ...
    if (dt %in% timeID2) {
      ...
      saveRDS(aDCC.GARCH.USDJPY[[i]], paste0(
        'data/fx/', subdir, '/aDCC.GARCH.USDJPY.', 
...
```{r FDCC-HLVARF, message=FALSE, warning=FALSE, eval=FALSE, echo=FALSE}
## ------------- Simulate mv_fx() ----------------------
## mv_fx just made the model and some argument flexible.
## Multivariate models.
md <- c('DCC', 'aDCC', 'FDCC')
...
#data/fx/USDJPY/FDCC.GARCH.USDJPY.2013-01-14.rds saved!
#FDCC.HL.solnp error.
#Error in FDCC.GARCH.USDJPY[[i]] : subscript out of bounds
#tmID <- c('2013-02-04', '2013-02-05', '2013-02-25', '2013-04-11', '2013-04-14', 
#          '2013-04-15', '2013-04-22', '2013-04-23', '2013-04-24', '2014-10-28', 
#          '2014-10-29', '2014-10-30') %>% 
#  ymd
timeID %<>% .[. > ymd('2014-11-28')]
...
for (dt in timeID) {
  ...
  for (i in seq(cr_code[7])) {
    ...
    if (dt %in% timeID2) {
      ...
      FDCC.GARCH.USDJPY[[i]] <- tryCatch({ldply(md[2], function(y) {
        df = tryCatch(
          mv_fx(smp, .model = y, .solver = 'solnp', .currency = cr_code[7],#[i], 
                .price_type = 'HL', .VAR = FALSE, .cluster = .cl), 
          error = function(e) cat(paste0(y, '.HL.', 'solnp', ' error.\n')))
      ...
      saveRDS(FDCC.GARCH.USDJPY[[i]], paste0(
        'data/fx/', subdir, '/FDCC.GARCH.USDJPY.', 
...
```{r dcc-HLCVARF, message=FALSE, warning=FALSE}
...
```{r dcc-CVARF, message=FALSE, warning=FALSE}
...
```{r goGARCH-HLVART, message=FALSE, warning=FALSE}

```

#### VAR=FALSE

```{r goGARCH-HLVARF, message=FALSE, warning=FALSE}
...
```{r goGARCH-HLCVART, message=FALSE, warning=FALSE}
...
```{r goGARCH-CVART, message=FALSE, warning=FALSE}
...
```{r cGARCH-HLVART, message=FALSE, warning=FALSE}
...
```{r cGARCH-HLCVART, message=FALSE, warning=FALSE}
...
```{r cGARCH-CVART, message=FALSE, warning=FALSE}
