...
### Nested Daily-Weekly-Monthly-Quarterly Model
...
comp <- join(data_m1, comp) %>% ##The last observation of Firday is Saturday 00:00:00 but not next Monday 00:00:00. Therefore the Saturday forecasted price will not be merge with Next Monday market price. The 
  tbl_df %>% 
  na.omit
```
