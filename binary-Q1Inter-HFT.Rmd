...
By refer to section [7.1.3 Unexpected Error](https://rpubs.com/englianhu/binary-Q1Inter-HFT.html#713_Unexpected_Error), here I omitted the data from year `2018-01-01` to `2018-07-09` but the outcome is same. Here I forced to omit the mentioned dataset.
...
*source : [Scaled errors & Examples](https://otexts.com/fpp2/accuracy.html#scaled-errors)*
