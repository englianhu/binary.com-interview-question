...
aic.s %>% formattable(list(
    ...
    AIC = formatter('span', style = x ~ formattable::style(color = ifelse(rank(x) >= 3, 'gray', 'green')), x ~ paste0(round(x, 6), ' (rank: ', sprintf('%02d', rank(x)), ')'))))
```
...
## 7.2 Reference
  ...
  02. [<span style='color:blue'>...</span>](https://github.com/scibrokes/odds-modelling-and-testing-inefficiency-of-sports-bookmakers)
