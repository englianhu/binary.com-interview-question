...
## Due to minutes nor hours dataset not completed and always happans error, here only read daily data but not minutes, hours etc.
fls <- dir('./data', pattern = 'USD+.+.csv') %>% str_replace_all('_1m.csv', '')
...
mse.arima <- suppressAll(join(d6m, d1y))
