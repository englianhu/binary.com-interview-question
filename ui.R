                          ...
                          tabsetPanel(
                                     ...
                                     sidebarLayout(
                                       sidebarPanel(
                                         bsCollapse(id = 'selectSIFund', open = 'Select Fund', 
                                                    bsCollapsePanel('Select Latest Data Date and Predicted Date', 
                                                                    #'@ dateRangeInput('dataRange', label = 'Data Range', 
                                                                    #'@                start = first(dateRange), end = last(dateRange)), 
                                                                    dateInput('dataDate', value = last(dateRange) - 1, label = 'Last Data Date'), 
                                                                    dateInput('preDate', value = last(dateRange), label = 'Predicted Date'), 
                            ...
                            tabPanel('Answer (Back-End)', 
                                     ...
                                     p('In order to predict the LAD (stock price of ', HTML("<a href='https://www.ladbrokescoralplc.com/'>LadbrokesCoral PLC</a>"), '), I get the real-time stock price from ', 
                                       strong('Yahoo'), '. Below is a chart trend of LAD stock price from ', textOutput('firstday', inline = TRUE), ' onwards. (sample data)'), 
                                     #'@ highchartOutput("hcontainer", height = "500px"), 
                                     p(tags$a(href='https://www.ladbrokescoralplc.com/', target='_blank', 
