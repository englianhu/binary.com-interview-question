                            ...
                            tabPanel('Answer (Font-End)', 
                                     sidebarLayout(
                                       ...
                                       mainPanel(
                                         ...
                                         br(), 
                                         h4('1. Forecast'), 
                                         p('The graph below forecast the stocks price. You are feel free to select a predict date from the sidebar.'), 
                                         br(), 
                                         br(), 
                                         p('The graph showing the predicted stocks price with closing price of stocks counter ', 
                                         ...
                                         br(), 
                                         h4('Miscellaneous'), 
                                         p('We have few affiliates partners and below are some among our business partners. You are feel free to join as an affiliate with below client/partner companies.', 
                                           tags$ul(
                            ...
                            tabPanel('Answer (Back-End)', 
                                     ...
                                     p('I used to work in ', tags$a(href='http://www.scicom-intl.com/', target='_blank', 
                                       ...
                                       ' with ', tags$a(href='http://www.ladbrokes.com/home/en', target='_blank', 
                                                        tags$img(height = '20px', alt='hot', #align='right', 
                                                                 src='ladbrokes.jpg')), ' Far East Asia project as customer service executive for couple years. Here I took the client company as my analysis for this job interview. In order to predict the LAD (stock price of ', 
                                       HTML("<a href='https://www.ladbrokescoralplc.com/'>LadbrokesCoral PLC</a>"), '), I get the real-time stock price from ', 
                                     ...
                                     p('Due to I checked above models and all same (with different ', code('pred.type'), 
                                       ' or ', code('measure.type') , '). Here I randomly pick one to compare from Ridge to Lasso (0, 0.1, 0.2... 1.0). Above models all get the same result which is alpha 0.8. from 2015-01-01 until 2017-01-18.'), 
                                     p('Here I tried to redo with selecting a 365 days dataset to test the best model and got that alpha ', textOutput('bestalpha', inline = TRUE), ' is the best fit.'), 
                                     p('Remarks : From my research, different size of observation, order of the date or maximum iteration will come out with different result as well.'), 
                                     br(), 
                                     br(), 
                                     h4('2. Prediction'), 
                                     p('sample graph for comparison of predicted price from alpha 0, 0.1, 0.2... 1. You can simply using ', 
                                       code('predict'), ' function and set a ', code('newx') , ' will do.'), 
                                     #'@ highchartOutput("hcmp", height = "500px"), 
                                     p(tags$a(href='https://www.ladbrokescoralplc.com/', target='_blank', 
                                     tags$img(height = '500px', alt='hot', #align='right', 
                                              src='LAD_Cmp.jpg'))), 
                                     ...
                                     br(), 
                                     h4('3. Staking Model'), 
                                     p('I am currently conducting research on betting strategy. You are feel free to browse over my researchs.', 
                                       tags$ul(
                                     ...
                                     p('The formula of Kelly as below :', 
                                       ...
                                       tags$ul(
                                         ...
                                         tags$li(em('P'), 'Payout'))), 
                                     p('Kelly Criterion and Optimal f are very similar models for geometric growth optimization. Ralph Vince’s article ', 
                                       ...
                                       ' did a test in R to compare these two models. Considering a 50/50 coin flipping game that pays $2 on heads and -$0.5 on tails for every $1 you bet. Through optimizing Kelly’s objective function', 
                                     ...
                                     p('You are feel free to read the article in ', 
                                       strong('Reference'), ' named ', HTML("<a href='https://alphaism.wordpress.com/2012/04/13/testing-kelly-criterion-and-optimal-f-in-r/'>Testing Kelly Criterion and Optimal f in R</a>"), 
