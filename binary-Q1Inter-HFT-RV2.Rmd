...
mds_ets_MNN_intraday2_1min_1y_cmp <- mds_ets_MNN_intraday2_1min_1y %>% 
  #tidyr::unite(model, t_series:part) %>% 
  tidyr::unite(model, t_series:fc_min) %>% 
  as.data.table %>% 
  .[, .(index, model, mk.price, fc.price)] %>% as.data.table

mds_ets_MNN_intraday2_1min_1y_cmp <- as.data.table(mds_ets_MNN_intraday2_1min_1y_cmp)

## ----------------------------------------
## fromLast = FALSE
mds_ets_MNN_intraday2_1min_1y_cmp_fLF <- unique(
  mds_ets_MNN_intraday2_1min_1y_cmp[, .(index, model, mk.price, fc.price)], fromLast = FALSE)

## save dataset in data.table format
saveRDS(mds_ets_MNN_intraday2_1min_1y_cmp_fLF, 
        paste0(.dtr, 'data/fx/USDJPY/mds_ets_MNN_intraday2_1min_1y_cmp_fLF.rds'))

## ----------------------------------------
## fromLast = TRUE
mds_ets_MNN_intraday2_1min_1y_cmp_fLT <- unique(
  mds_ets_MNN_intraday2_1min_1y_cmp[, .(index, model, mk.price, fc.price)], fromLast = TRUE)

## save dataset in data.table format
saveRDS(mds_ets_MNN_intraday2_1min_1y_cmp_fLT, 
        paste0(.dtr, 'data/fx/USDJPY/mds_ets_MNN_intraday2_1min_1y_cmp_fLT.rds'))

## ----------------------------------------
## convert to long format for plot chart
## fromLast = FALSE
prc <- unique(mds_ets_MNN_intraday2_1min_1y_cmp[, .(index, model, mk.price)], fromLast = FALSE)
prc <- prc[, model := 'actual'][]
setnames(prc, old = 'mk.price', new = 'price')
prc <- unique(prc, fromLast = FALSE)

mds_ets_MNN_intraday2_1min_1y_grph <- unique(
  mds_ets_MNN_intraday2_1min_1y_cmp[, .(index, model, fc.price)], fromLast = FALSE)
setnames(mds_ets_MNN_intraday2_1min_1y_grph, old = 'fc.price', new = 'price')

mds_ets_MNN_intraday2_1min_1y_grph <- rbind(mds_ets_MNN_intraday2_1min_1y_grph, prc)
mds_ets_MNN_intraday2_1min_1y_grph_fLF <- data.table(mds_ets_MNN_intraday2_1min_1y_grph)[order(index)]
rm(prc)

## save dataset in data.table format
saveRDS(mds_ets_MNN_intraday2_1min_1y_grph_fLF, 
        paste0(.dtr, 'data/fx/USDJPY/mds_ets_MNN_intraday2_1min_1y_grph_fLF.rds'))

## ----------------------------------------
## fromLast = TRUE
prc <- unique(mds_ets_MNN_intraday2_1min_1y_cmp[, .(index, model, mk.price)], fromLast = TRUE)
prc <- prc[, model := 'actual'][]
setnames(prc, old = 'mk.price', new = 'price')
prc <- unique(prc, fromLast = TRUE)

mds_ets_MNN_intraday2_1min_1y_grph <- unique(
  mds_ets_MNN_intraday2_1min_1y_cmp[, .(index, model, fc.price)], fromLast = TRUE)
setnames(mds_ets_MNN_intraday2_1min_1y_grph, old = 'fc.price', new = 'price')

mds_ets_MNN_intraday2_1min_1y_grph <- rbind(mds_ets_MNN_intraday2_1min_1y_grph, prc)
mds_ets_MNN_intraday2_1min_1y_grph_fLT <- data.table(mds_ets_MNN_intraday2_1min_1y_grph)[order(index)]
rm(prc)

## save dataset in data.table format
saveRDS(mds_ets_MNN_intraday2_1min_1y_grph_fLT, 
        paste0(.dtr, 'data/fx/USDJPY/mds_ets_MNN_intraday2_1min_1y_grph_fLT.rds'))
```
...
*source : `r paste0(dim(mds_ets_MNN_intraday3_1min_1y), collapse = ' x ')`*
...
*source : `r paste0(dim(mds_ets_MNN_intraday3_1min_1y_grph_fLF), collapse = ' x ')`*
...
*source : `r paste0(dim(mds_ets_MNN_intraday3_1min_1y_grph_fLT), collapse = ' x ')`*
...
*source : `r paste0(dim(rp3_1min_1y_tbl), collapse = ' x ')`*

```{r include = FALSE}
if(exists('rp3_1min_1y_tbl')) rm(rp_1min_tbl)
```
...
```{r include = FALSE}
if(exists('rp3_1min_1y_tbl')) rm(rp_1min_1y_tbl)
```
...
rp3_1y_fLF <- rp3_1y_fLF[, arrange := 'from_first'][]
rp3_1y_fLT <- rp3_1y_fLT[, arrange := 'from_last'][]

rp3_1min_1y_fLF <- rp3_1min_1y_fLF[, arrange := 'from_first'][]
rp3_1min_1y_fLT <- rp3_1min_1y_fLT[, arrange := 'from_last'][]

rp_1min_1y <- rbindlist(list(rp_1min_1y_fLF, rp_1min_1y_fLT, rp3_1min_1y_fLF, rp3_1min_1y_fLT))
