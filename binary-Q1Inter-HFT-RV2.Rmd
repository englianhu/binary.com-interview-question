...
```{r 16hr-1min, warning = FALSE, message = FALSE, results = 'asis'}
#```{r, warning = FALSE, message = FALSE, results = 'asis'}
...
```{r 14hr-1min, warning = FALSE, message = FALSE, results = 'asis'}
#```{r, warning = FALSE, message = FALSE, results = 'asis'}
...
```{r 12hr-1min, warning = FALSE, message = FALSE, results = 'asis'}
#```{r, warning = FALSE, message = FALSE, results = 'asis'}
...
```{r 10hr-1min, warning = FALSE, message = FALSE, results = 'asis'}
#```{r, warning = FALSE, message = FALSE, results = 'asis'}
...
From table above, we know that `r unique(sum$model)[1]` and `r unique(sum$model)[2]` is the <span style='color:white; background-color:#DE5D83;'>**β**est model</span>.
