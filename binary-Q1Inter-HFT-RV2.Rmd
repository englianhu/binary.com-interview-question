...
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_1440')[1]
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_720')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_480')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_360')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_240')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_180')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_120')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_60')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_30')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_20')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_15')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_10')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_8')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_6')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, eval = FALSE}
#```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_5')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, eval = FALSE}
#```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_4')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, eval = FALSE}
#```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_3')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, eval = FALSE}
#```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_2')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
...
```{r, eval = FALSE}
#```{r, warning = FALSE, message = FALSE, results='asis'}
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY'), pattern = '^ts_ets_MNN_1440_1')[1]
smp <- readRDS(paste0(.dtr, 'data/fx/USDJPY/', fl))
