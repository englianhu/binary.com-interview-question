...
# --------- eval=FALSE ---------
ets.m <- 'MNN'
source('function/dl1440_hrz720.R')
...
llply(ets.m, function(md) {
  dl1440_hrz720(timeID = timeID, dsmp, 
                data_len = data_len, hrz1 = hrz1, 
                .model = md)
  })
```
...
# --------- eval=FALSE ---------
ets.m <- 'MNN'
source('function/dl1440_hrz480.R')
...
llply(ets.m, function(md) {
  dl1440_hrz480(timeID = timeID, dsmp, 
                data_len = data_len, hrz1 = hrz1, 
                .model = md)
  })
```
...
# --------- eval=FALSE ---------
ets.m <- 'MNN'
source('function/dl1440_hrz360.R')
...
llply(ets.m, function(md) {
  dl1440_hrz360(timeID = timeID, dsmp, 
                data_len = data_len, hrz1 = hrz1, 
                .model = md)
  })
```
...
# --------- eval=FALSE ---------
ets.m <- 'MNN'
source('function/dl1440_hrz240.R')
...
llply(ets.m, function(md) {
  dl1440_hrz240(timeID = timeID, dsmp, 
                data_len = data_len, hrz1 = hrz1, 
                .model = md)
  })
```
...
# --------- eval=FALSE ---------
ets.m <- 'MNN'
source('function/dl1440_hrz180.R')
...
llply(ets.m, function(md) {
  dl1440_hrz180(timeID = timeID, dsmp, 
                data_len = data_len, hrz1 = hrz1, 
                .model = md)
  })
```
...
# --------- eval=FALSE ---------
ets.m <- 'MNN'
source('function/dl1440_hrz120.R')
...
llply(ets.m, function(md) {
  dl1440_hrz120(timeID = timeID, dsmp, 
                data_len = data_len, hrz1 = hrz1, 
                .model = md)
  })
```
...
# --------- eval=FALSE ---------
ets.m <- 'MNN'
source('function/dl1440_hrz60.R')
...
llply(ets.m, function(md) {
  dl1440_hrz60(timeID = timeID, dsmp, 
               data_len = data_len, hrz1 = hrz1, 
               .model = md)
  })
```
...
# --------- eval=FALSE ---------
ets.m <- 'MNN'
source('function/dl1440_hrz30.R')
...
llply(ets.m, function(md) {
  dl1440_hrz30(timeID = timeID, dsmp, 
               data_len = data_len, hrz1 = hrz1, 
               .model = md)
  })
```
...
# --------- eval=FALSE ---------
ets.m <- 'MNN'
source('function/dl1440_hrz20.R')
...
llply(ets.m, function(md) {
  dl1440_hrz20(timeID = timeID, dsmp, 
               data_len = data_len, hrz1 = hrz1, 
               .model = md)
  })
```
...
# --------- eval=FALSE ---------
ets.m <- 'MNN'
source('function/dl1440_hrz10.R')
...
llply(ets.m, function(md) {
  dl1440_hrz10(timeID = timeID, dsmp, 
               data_len = data_len, hrz1 = hrz1, 
               .model = md)
  })
```
...
llply(ets.m, function(md) {
  dl1440_hrz5(timeID = timeID, dsmp, 
              data_len = data_len, hrz1 = hrz1, 
              .model = md)
  })
```
...
llply(ets.m, function(md) {
  dl1440_hrz3(timeID = timeID, dsmp, 
              data_len = data_len, hrz1 = hrz1, 
              .model = md)
  })
```
...
llply(ets.m, function(md) {
  dl1440_hrz1(timeID = timeID, dsmp, 
              data_len = data_len, hrz1 = hrz1, 
              .model = md)
  })
```
