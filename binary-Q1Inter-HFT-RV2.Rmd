...
fl <- list.files(paste0(.dtr, 'data/fx/USDJPY/intraday/'), pattern = '^ts_ets_MNN_1440_1440.[0-9]{4}')[1]
...
saveRDS(mds_ts, paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ts.rds'))

saveRDS(mds_ets_AAN_MAZ, 
         paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ets_AAN_MAZ.rds'))

saveRDS(mds_ets_MMN_ZAN, 
         paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ets_MMN_ZAN.rds'))

saveRDS(mds_ets_ZAZ_ZZZ, 
        paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ets_ZAZ_ZZZ.rds'))
```

```{r, eval = FALSE}
mds_ts <- read_rds(
  paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ts.rds'))
...
if(!exists('mds_ts')) {
  mds_ts <- read_rds(paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ts.rds')) }
...
saveRDS(mds_ts_cmp, paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ts_cmp.rds'))
...
## save dataset in data.table format
saveRDS(mds_ts_grph, paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ts_grph.rds'))
```
...
saveRDS(mds_ets_AAN_MAZ_cmp, 
        paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ets_AAN_MAZ_cmp.rds'))
...
saveRDS(mds_ets_AAN_MAZ_grph, 
        paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ets_AAN_MAZ_grph.rds'))
```
...
saveRDS(mds_ets_MMN_ZAN_cmp, 
        paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ets_MMN_ZAN_cmp.rds'))
...
saveRDS(mds_ets_MMN_ZAN_grph, 
        paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ets_MMN_ZAN_grph.rds'))
```
...
saveRDS(mds_ets_ZAZ_ZZZ_cmp, 
        paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ets_ZAZ_ZZZ_cmp.rds'))
...
saveRDS(mds_ets_ZAZ_ZZZ_grph, 
        paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ets_ZAZ_ZZZ_grph.rds'))
```

```{r}
if(!exists('mds_ts_grph')) {
  mds_ts_grph <- readRDS(
    paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ts_grph.rds')) }
...
if(!exists('mds_ts_cmp')) {
  mds_ts_cmp <- read_rds(
    paste0(.dtr, 'data/fx/USDJPY/intraday/mds_ts_cmp.rds')) }
...
rm(rp1, rp2, rp3, rp4)
saveRDS(rp_fLF, paste0(.dtr, 'data/fx/USDJPY/intraday/rp_fLF.rds'))
```

```{r, warning = FALSE, message = FALSE, results='asis'}
rp_fLF <- readRDS(paste0(.dtr, 'data/fx/USDJPY/intraday/rp_fLF.rds'))
...
rm(rp1, rp2, rp3, rp4)
saveRDS(rp_fLT, paste0(.dtr, 'data/fx/USDJPY/intraday/rp_fLT.rds'))
```

```{r, warning = FALSE, message = FALSE, results='asis'}
rp_fLT <- readRDS(paste0(.dtr, 'data/fx/USDJPY/intraday/rp_fLT.rds'))
