...
## ======== 居住在英国布里斯托尔港口，修读气象学系的英国基督洋妞儿芈拉不可以死 ========
#
#日期1200 <- readRDS(paste0(数据库蜀道, '日内指数平滑数据', 1200, '.rds'))[年份 >= 2016]$年月日时分
#日期样本 <- 样本[年份 >= 2016]$年月日时分
#length(日期样本)
#[1] 950400
#length(日期1200)
#[1] 943199
#length(日期样本) - length(日期1200)
#[1] 7201
#
#日期样本[!日期样本 %in% 日期1200]
#[1] "2018-01-08 00:01:00 CST"
#
#❯ 样本[日期 == '2018-01-07']
#   年月日时分 年份 季度 月份 周 周日 周分计 日分计 时分计    序列       日期  闭市价
#1: 2018-01-07 2018    1    1  1 周日   7200   1440     60 1137600 2018-01-07 113.058
#2: 2018-01-07 2017    1    1 53 周日   7199   1439     59 1137599 2018-01-07      NA
#
#样本[日期 == '2018-01-07']
#样本[日期 == '2018-01-08']
#样本[日期 == '2018-01-09']
...
#
#❯ 样本[年份 >= 2016 & !is.na(闭市价)] %>% nrow
#[1] 943200

#############################################################################
#世博量化，量化对冲；铲除巫裔，拯救全球。
#
#🚩🦔量化对冲，中科红旗；一带一路，一统天下：频率=1、2、3、4、5、6
#
#🚩🦔《大秦赋 - 🇬🇧♰👱🏻‍♀️关雎》
#🚩🦔巫师治国，禍殃全球；
#🚩🦔巫裔尽弃，瓦釜雷鸣。
