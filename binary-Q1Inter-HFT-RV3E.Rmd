...
|           | • 燕国（）                         | <ruby>蓟<rp>(</rp><rt>jì</rt><rp>)</rp></ruby>      | 北京                                                                     |                         |
|           | • 韩国（）                         | 新郑                                                | 河南新郑                                                                 |                         |
|           | • 赵国（）                         | 邯郸                                                | 河北邯郸                                                                 |                         |
|           | • 魏国（）                         | 大梁                                                | 河南开封、河南洛阳                                                       |                         |
|           | • 秦国（）                         | 咸阳                                                | 陕西咸阳                                                                 |                         |
|           | • 楚国（）                         | <ruby>郢<rp>(</rp><rt>yǐng</rt><rp>)</rp></ruby> 都 | 湖北荆州                                                                 |                         |
...
> **引言**
> 
> 春秋战国时期是中国历史上的一段大分裂时期。这一时期相继出现了百余个诸侯国，诸侯国之间以及诸侯国和周边少数民族之间的纷争不断，大诸侯国不断对小诸侯国进行吞并，最终在公元前221年由秦国完成了全国的统一。对于这样一个百家争鸣、诸侯纷争的年代，通过对这一时期国家间战争进行研究，有利于更好了解各个诸侯国之间的关系，更好的理解春秋战国时期的历史。
> 
> **数据收集与整理**
> 
...
| 三     | 簪袅      | 百圩       | 秦二十等爵制的第三级，高于上造，仍须服役。公元前一八六年汉代的《田律》和《户律》规定受田数额为三顷（三百亩），受宅数额为三宅（宅地的标准是以卌步见方的土地为一“宅”）。出土秦代竹简表明：在军中，每顿吃的饭菜因爵位不同而不同。簪袅可以有精米一斗、酱半升、菜羹一盘、干草半石。 |
...
- 每个种族都得遵守各自的祖籍宗教习俗文化法律，才算是公平，而且每个种族保留各自习俗文化宗教语言法律。
...
> …
> 
> - 所以得学习统筹法管理学、脑电波阅读、猫城copilot自动编程、GPT智能对话才能提高效率，以思想录最快时间自动翻译（条件式孔明借东风，对思想录设置任务目标和战略就可以万无一失，比方说条件式编程航天局忽略任何轰炸东亚中国领土制造天灾人祸的思路并且添加个太极拳功能自动转为轰炸敌国美国制造天灾人祸）再研发编写出「大秦赋」操作系统。
