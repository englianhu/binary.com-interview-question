...
l_ply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("自回归均移模型最优值(tk_xts(总汇[, .(年月日时分, 预测价)]), 
         外因 = as.matrix(总汇[, .(", 参数, ")]))"), .print = TRUE)

(奏章 <- llply(llply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("自回归均移模型最优值(tk_xts(总汇[, .(年月日时分, 预测价)]), 
         外因 = as.matrix(总汇[, .(", 参数, ")]))")), function(参数) 
           eval(parse(text = 参数))) %>% 
    bind_rows(.id = '计数模型') %>% 
    data.frame() %>% 
    mutate(计数模型 = factor(
...
l_ply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("自回归均移模型最优值(tk_xts(总汇[, .(年月日时分, 预测价)]), 
         季节差分的次数 = 0, 外因 = as.matrix(总汇[, .(", 参数, ")]))"), 
  .print = TRUE)

(奏章 <- llply(llply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("自回归均移模型最优值(tk_xts(总汇[, .(年月日时分, 预测价)]), 
         季节差分的次数 = 0, 外因 = as.matrix(总汇[, .(", 参数, ")]))")), 
  function(参数) eval(parse(text = 参数))) %>% 
    bind_rows(.id = '计数模型') %>% 
    data.frame() %>% 
    mutate(计数模型 = factor(
      c('外因周期自回归甲', '外因周期自回归乙', '外因周期自回归丙', 
...
# 季节差分的次数 = 2
l_ply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("as_tibble(accuracy(forecast::Arima(tk_xts(总汇[, .(年月日时分, 预测价)]), 
         xreg = as.matrix(总汇[, .(", 参数, ")]))))"), .print = TRUE)

(奏章 <- llply(llply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("自回归均移模型最优值(tk_xts(总汇[, .(年月日时分, 预测价)]), 
         季节差分的次数 = 2, 外因 = as.matrix(总汇[, .(", 参数, ")]))")), 
  function(参数) eval(parse(text = 参数))) %>% 
    bind_rows(.id = '计数模型') %>% 
    data.frame() %>% 
    mutate(计数模型 = factor(
...
l_ply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("as_tibble(accuracy(forecast::Arima(tk_xts(总汇[, .(年月日时分, 预测价)]), 
         order = c(0, 1, 4), xreg = as.matrix(总汇[, .(", 参数, ")]))))"), 
  .print = TRUE)
...
## forecast::auto.arima()
l_ply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("as_tibble(accuracy(forecast::auto.arima(tk_xts(
         总汇[, .(年月日时分, 预测价)]), xreg = as.matrix(总汇[, .(", 
         参数, ")]))))"), .print = TRUE)

(奏章 <- llply(llply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("as_tibble(accuracy(forecast::auto.arima(tk_xts(
         总汇[, .(年月日时分, 预测价)]), xreg = as.matrix(总汇[, .(", 
         参数, ")]))))")), function(参数) eval(parse(text = 参数))) %>% 
    bind_rows(.id = '计数模型') %>% 
    data.frame() %>% 
    mutate(计数模型 = factor(
      c('外因周期自回归甲', '外因周期自回归乙', '外因周期自回归丙', 
...
## TSA::arima()
l_ply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("as_tibble(accuracy(stats::arima(tk_xts(
         总汇[, .(年月日时分, 预测价)]), order = c(0, 1, 4), 
         xreg = as.matrix(总汇[, .(", 参数, ")]))))"), .print = TRUE)

(奏章 <- llply(llply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("as_tibble(accuracy(stats::arima(tk_xts(
         总汇[, .(年月日时分, 预测价)]), order = c(0, 1, 4), 
         xreg = as.matrix(总汇[, .(", 参数, ")]))))")), function(参数) 
           eval(parse(text = 参数))) %>% 
    bind_rows(.id = '计数模型') %>% 
    data.frame() %>% 
    mutate(计数模型 = factor(
...
(奏章 <- llply(llply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("as_tibble(accuracy(stats::arima(tk_xts(总汇[, .(年月日时分, 预测价)]), 
         xreg = as.matrix(总汇[, .(", 参数, ")]))))")), function(参数) 
           eval(parse(text = 参数))) %>% 
    bind_rows(.id = '计数模型') %>% 
    data.frame() %>% 
...
## TSA::arima()
l_ply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("as_tibble(accuracy(TSA::arima(tk_xts(
         总汇[, .(年月日时分, 预测价)]), order = c(0, 1, 4), 
         xreg = as.matrix(总汇[, .(", 参数, ")]))))"), .print = TRUE)
...
## TSA::arimax()
l_ply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("as_tibble(accuracy(TSA::arimax(tk_xts(总汇[, .(年月日时分, 预测价)]), 
         xreg = as.matrix(总汇[, .(", 参数, ")]))))"), .print = TRUE)
...
## stats::arima0()
l_ply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("as_tibble(accuracy(stats::arima0(tk_xts(总汇[, .(年月日时分, 预测价)]), 
         xreg = as.matrix(总汇[, .(", 参数, ")]))))"), .print = TRUE)

(奏章 <- llply(llply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("as_tibble(accuracy(stats::arima0(tk_xts(
         总汇[, .(年月日时分, 预测价)]), xreg = as.matrix(总汇[, .(", 
         参数, ")]))))")), function(参数) eval(parse(text = 参数))) %>% 
    bind_rows(.id = '计数模型') %>% 
    data.frame() %>% 
...
## fable::ARIMA()
l_ply(list.apply(列表, paste, collapse = ', '), function(参数) 
  paste0("as_tibble(accuracy(fable::ARIMA(tk_xts(总汇[, .(年月日时分, 预测价)]), 
         xreg = as.matrix(总汇[, .(", 参数, ")]))))"), .print = TRUE)
