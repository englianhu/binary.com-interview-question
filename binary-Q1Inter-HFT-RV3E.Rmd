...
日内指数平滑数据2018年1月结论 <- 总汇结论(总汇 = 日内指数平滑数据2018年1月总汇, 文件名 = '日内指数平滑数据2018年1月', 是否储存结论 = '勾')
```
...
日内指数平滑数据2018年1月平滑周计总汇 <- 日内指数平滑数据2018年1月平滑周计总汇[, 月份 := data.table::month(年月日时分)][月份 == 1]



日内指数平滑数据2018年1月平滑周计结论 <- tidyft::llply(, 总汇结论(总汇 = 日内指数平滑数据2018年1月平滑周计总汇, 文件名 = '日内指数平滑数据2018年1月平滑周计', 是否储存结论 = '勾'), .progess = 'text')
```
