...
| 三     | <ruby>簪<rp>(</rp><rt>zān</rt><rp>)</rp>袅<rp>(</rp><rt>niǎo</rt><rp>)</rp></ruby>簪袅      | 百圩       | 秦二十等爵制的第三级，高于上造，仍须服役。公元前一八六年汉代的《田律》和《户律》规定受田数额为三顷（三百亩），受宅数额为三宅（宅地的标准是以卌步见方的土地为一“宅”）。出土秦代竹简表明：在军中，每顿吃的饭菜因爵位不同而不同。簪袅可以有精米一斗、酱半升、菜羹一盘、干草半石。 |
