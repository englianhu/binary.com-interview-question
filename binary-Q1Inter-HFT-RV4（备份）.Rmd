...
二、上图的漂亮妞儿就长得像农历二零零零年到二零零一年中四勤班和中五勤班时期，乘搭韵祯校车的隔壁校私立丹绒学妹国民华校校友**林燕芳**（🚩🇨🇳🔆🏹🌟👊🚀🦔中科红旗孙玉芳教授中正纪念堂殡涓之争，并非庞氏骗局）或赢家黄氏江夏堂家翁道教徒赢政永春好学的华越混血儿孙女状元黄筱婕（哥哥黄联升和越族阮美美的女儿，赢子婴），行不改名坐不改姓。现实生活中的**林燕芳**都是自强不息、学术优先，喜欢力争上游、前程似锦的咱们世袭制道教徒（歼灭任何巫贼巫婆非法回教徒和非法回教徒峇峇娘惹）才子的贤内助而非姓奴黄脸婆。

![*🚩🇨🇳🔆🏹🌟👊🚀🦔孙玉芳教授在二零零二年创办中科红旗曰：”国产操作系统廿年 - 进退攻防，战斗不止。“*](林燕芳（中学乘搭韵祯校车的隔壁校私立丹绒学妹，行不改名坐不改姓，或自个儿侄女黄筱婕）/国产操作系统廿年 - 进退攻防，战斗不止.png){width=400}

>> <iframe width="400" height="225" src="https://youtube.com/embed/mC-OkNNDdxI" title="「抖音」俺の日本語クラスマット林艶迎🇯🇵🇮🇹" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
> 
...
借鉴[文明史](#文明史)和民以食为天，洋蕃都爱食用大麦、小麦、麦片，以麦为主；而回教徒宗祖国阿拉伯的朝圣地点叫麦加（卖家、麦家）；而咱们亚洲人都爱食用米饭，以稻为主。咱们诸子百家中的稻、水稻、稻田、稻米、道教、道路、道听途说、秧苗助长、商鞅变法、戊戌变法、天狗食月、晏婴使楚（狗咬吕洞宾，不识好人心）、十二生肖、未羊、六滔、陈祯禄Sir Tan Cheng Lok（“六”和“绿”的粤语发音都是Lōk；食君之禄，担君之忧）公爵出生于马六甲、天干地支中的“己”、子曰中的“己”所不欲，“戊”施于人。有关诸子百家相关信息，请查阅[中国最精彩时代是春秋战国、 文化自由思想交融](http://m.news.xixik.com/content/49e3efc60bb86697)。
...
天下简史 <- data.frame(年份 = -5000:2024, 纪年法 = rep(干支, 118)[37:7061], 朝代 = NA, 年号 = NA, 国事 = NA, 钱谷 = NA, 战役 = NA, 战果 = NA)

朝代 <- c('夏朝' = -2070, '商朝' = -1600, '西周' = -1046, '春秋' = -770, '战国' = -475, '秦朝' = -221, '西汉' = -202, '新朝' = 9, '东汉' = 25, '三国' = 220, '西晋' = 266, '十六国' = 304, '南北朝' = 420, '隋朝' = 581, '唐朝' = 618, '五代十国' = 907, '宋朝' = 690, '辽国' = 907, '金国' = 1115, '西夏' = 1038, '元朝' = 1271, '明朝' = 1368, '清朝' = 1636, '中华民国' = 1912, '中华人民共和国' = 1949)
...
国事 <- c('姜太公钓鱼' = -1100, '周平王即位，东周开始' = -771, '道法/管子/管仲临盆' = -723, '齐恒公即位' = -685, '齐恒公称霸：尊王攘夷，九合诸侯。' = -681, '秦穆公即位' = -659, '宋襄公即位' = -651, '宋襄公称霸：春秋大义' = -639, '晋文公即位' = -636, '晋文公称霸：践土会盟，称霸诸侯。' = -632, '楚庄王即位' = -631, '秦穆公称霸：称霸西戎' = -623, '楚庄王问鼎' = -613, '楚襄王称霸：饮马黄河，问鼎中原。' = -597, '晏婴/晏子/晏仲临盆' = -578, '道家/老子/李耳临盆' = -571, '儒家/孔子/孔丘临盆' = -551, '墨家/墨子/墨翟临盆' = -476, '纵横家/鬼谷子/王诩/王禅临盆' = -400, '儒家/孟子/孟轲临盆' = -372, '道家/庄子/庄周临盆' = -369, '秦孝公求贤令' = -361, '秦惠文王即位' = -337, '法家/荀子/荀卿临盆' = -331, '秦惠文王诛商君，除巫裔，改元年。称秦王，誓东出' = -325, '燕惠王即位' = -279, '秦始皇登基' = -221, '司马迁临盆' = -145, '司马迁进言改历《汉历》' = -104, '司马迁完成《史纪》' = -91, '基督耶稣临盆' = 0, '曹操崛起' = 194, '陈群仕魏' = 198, '卧龙出渊' = 207, '曹丕魏文帝登基' = 220, '刘备汉烈祖登基' = 221, '孙权吴大帝登基' = 222, '晋武帝司马炎登基' = 266, '晋元帝司马睿登基' = 317, '袁世凯称帝' = 1859, '明治维新' = 1868, '岩仓使欧' = 1871, '孙中山立国' = 1912)
国事 <- data.frame(年份 = 国事, 国事 = names(国事)) %>% 
    as_tibble()

钱谷 = NA

战役 <- c('武王伐纣' = -1046, '长勺（sháo）之战' = -684, '三家分晋' = -633, '城濮之战与践土之盟' = -632, '弭（mǐ）兵之会' = -546, '吴越争霸' = -510, '吴国灭亡' = -473, '晋国灭亡' = -453, '商鞅变法' = -356, '桂陵之战' = -354, '马陵之战' = -342, '楚威王攻韩魏' = -334, '五国攻秦' = -318, '司马错伐巴蜀' = -316, '蜀相降秦' = -310, '合纵攻秦' = -298, '伊阙之战' = -290, '子鱼伐魏' = -289, '即墨之战 / 乐（yuè）毅（yì）伐齐' = -284, '子鱼伐楚' = -280, '长平之战' = -262, '邯郸之战' = -259, '赵破匈奴' = -244, '王翦灭赵' = -231, '王翦灭楚' = -224, '秦统天下' = -221, '黄巾之乱' = 184, '火烧洛阳' = 189, '兖州之战' = 194, '官渡之战' = 201, '晋阳起兵' = 617, '高平之战' = 954, '靖康之耻' = 1127, '红巾兵起义' = 1351, '鸦片战争（一）' = 1840, '黑船开国' = 1853, '鸦片战争（二）' = 1860, '辛酉政变' = 1861, '岩仓使欧' = 1871, '甲午战争' = 1894, '八国联军' = 1900, '辛亥革命' = 1911, '世界一战' = 1914, '世界二战' = 1931)
战役 <- data.frame(年份 = 战役, 战役 = names(战役)) %>% 
    as_tibble()

战果 <- c('取阳翟、鲁阳' = -334, '拿下巴蜀' = -316, '全歼韩魏联军廿四万，迫魏献河东地 四百里，韩献武遂地 皕里于秦。' = -290, '夺取魏国六十一城' = -289, '夺取楚国黔中郡' = -280)
战果 <- data.frame(年份 = 战果, 战果 = names(战果)) %>% 
    as_tibble()

天下简史 <- join_all(list(天下简史[c('年份', '纪年法')], 朝代, 年号, 国事, 战役, 战果), by = '年份') %>% 
  as_tibble() %>% 
  mutate(年份乙 = 年份, 年份 = paste0(str_replace_all(num2c(年份, lang = 'sc'), '负' , '公元前'), '年'), 钱谷 = NA) %>% 
    .[, c('年份', '年份乙', '纪年法', '朝代', '年号', '国事', '钱谷', '战役', '战果')]
...
> 鬼谷子，姓王名<ruby>诩<rp>(</rp><rt>xǔ</rt><rp>)</rp></ruby>（或利），又名王禅、王通，号玄微子，华夏族，一说春秋战国时期卫国朝歌（今河南省鹤壁市淇县）人；一说是战国时期魏国邺地人（河北省邯郸市临漳县香菜营乡谷子村）。春秋战国时期道家、兵家、纵横家的鼻祖，是中国历史上一位极具神秘色彩的人物，被誉为千古奇人，长于持身养性，精于心理揣摩，深明刚柔之势，通晓纵横捭阖之术，独具通天之智。常入云梦山采药修道。因隐居周阳城清溪之鬼谷，故自称鬼谷先生。一说是山西吕梁交口云梦山（现仍存棋盘山，和清溪一条。环境优美如世外桃源。是隐士生活的不二选择。也是北方少有的清幽之地。）“王禅老祖”是后人对鬼谷子的称呼，是先秦诸子之一。鬼谷子为纵横家之鼻祖（也是兵家的著名代表人物之一），苏秦与张仪为其最杰出的两个弟子（见《战国策》）。另有与亦为其弟子之说（见《孙庞演义》）。他通天彻地，兼顾数家学问，人不能及。一是神学:日星象纬，占卜八卦，预算世故，十分精确；二是兵学，六韬三略，变化无穷，布阵行军，鬼神莫测；三是游学，广记多闻，明理审势，出口成章，万人难当；四是出世学，修身养性，祛病延寿，学究精深。
> 
> 基本信息
> 中文名：王诩
> 外文名：Wang Xu
...
*出处：[「豆瓣」鬼谷子简介](https://movie.douban.com/review/10572551)*
...
<iframe width="400" height="225" src="https://youtube.com/embed/0OvkWGRhf_g" title="Lamborghini V12 Vision GT" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="400" height="225" src="https://youtube.com/embed/ISiIZYZW8TQ" title="商鞅变法：华夏历史上最邪恶的改革" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<iframe width="400" height="225" src="https://youtube.com/embed/u_DYBdlyMYg" title="「三维地图」商鞅变法的具体内容是什么，为什么他的变法能让秦国从此崛起？一个视频带你了解全部" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
- [《商鞅变法》与《王莽改制》](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/诸子百家/《商鞅变法》与《王莽改制》.pdf)
- [《商君书》秦王朝专制政治的黑暗心脏](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/诸子百家/《商君书》秦王朝专制政治的黑暗心脏.pdf)
- [《资本论》与社会主义财政理论](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/诸子百家/《资本论》与社会主义财政理论.pdf)
- [从「商鞅变法」探索初创型企业的管理制度（上）](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/诸子百家/从「商鞅变法」探索初创型企业的管理制度（上）.pdf)
- [从「商鞅变法」探索初创型企业的管理制度（下）](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/诸子百家/从「商鞅变法」探索初创型企业的管理制度（下）.pdf)
- [商鞅「农战」政策推行与帝国兴衰](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/诸子百家/商鞅「农战」政策推行与帝国兴衰.pdf)
- [从商鞅变法看绩效管理的作用](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/诸子百家/从商鞅变法看绩效管理的作用.pdf)
...
> 
> ☪️🕉️世袭制法家回教徒的可兰经习俗文化宗教语言断肢法，学习或参与使用任何外文学术数学算卜概率论博弈论、习俗文化宗教语言、吃猪肉喝酒抽烟、色情、勾引、迷魂、巫术降头等，都是触犯可兰经回教刑事法典断肢法。

*引用：[☪️🕉️斩首、石刑、截肢…阿富汗“伊斯兰教法”或将重现酷刑](https://www.163.com/dy/article/HM881SKU0511RVG1.html)*
...
- [「人物传记」秦惠文王的一生——彪悍到不需要解释](http://www.360doc.com/content/20/0620/09/11532035_919501336.shtml)
...
- [吕氏春秋全鉴](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/诸子百家/吕氏春秋全鉴.pdf)
...
借鉴春秋战国史和近代明治维新史，可先查阅：

- [🔆明治维新VS洋务运动，同时代的改革为何走向不同的结局](https://www.sohu.com/a/451217954_557768)
- [解密复兴科技 - 基于隐蔽马尔科夫模型的时序分析方法](https://github.com/englianhu/binary.com-interview-question/blob/世博量化研究院/图书馆/解密复兴科技%20-%20基于隐蔽马尔科夫模型的时序分析方法.pdf)了解目前几十年来投资回酬世界第一（比瓦伦∙巴菲特的平均年投资回酬率高）的文艺复兴科技。

欲发展咱们☯️道教、杏林、金融、道家与务农与金融科技、娱乐圈相关信息，可查阅[复兴赢家黄氏江夏堂](#复兴赢家黄氏江夏堂)，功勋超过历代三黄五帝，史称「秦始皇」，请查阅[黄氏与皇室](#黄氏与皇室)、[复兴赢家黄氏江夏堂](#复兴赢家黄氏江夏堂)。
...
- [金融工程原理](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/诸子百家/金融工程原理.pdf)
- [金融数学 - 衍生产品定价引论](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/诸子百家/金融数学%20-%20衍生产品定价引论.pdf)
- [金融数学教程](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/诸子百家/金融数学教程.pdf)
- [金融数学模型](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/诸子百家/金融数学模型.pdf)
- [高频交易系统开发的各个阶段是怎样的？](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/大秦赋之干支算筹/高频交易系统开发的各个阶段是怎样的？.pdf)
- [高频交易系统是不是绝大多数都是基于曦佳佳开发的？](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/大秦赋之干支算筹/高频交易系统是不是绝大多数都是基于曦佳佳开发的？.pdf)
- [量化对冲策略解读及配置价值分析](https://github.com/englianhu/library/blob/世博量化研究院/始祖永春∙秦谏（诸子百家，中文编程）/秦国始祖道家∙赢政黄永春ξηg%20Tεηg、道家一统天下的电子仪器「干支算筹」和操作系统「大秦赋」）/大秦赋之干支算筹/量化对冲策略解读及配置价值分析.pdf)
- 欲知更多金融相关文献，请查阅：
...
- [汇编语言之GNU ARM](https://cloud.tencent.com/developer/article/1866970)
- 
...
- [整理几个适合超微半导体中央处理单位的礼逆袭发行版](https://www.ecscoupon.com/4252.html)
...
<iframe width="400" height="225" src="https://youtube.com/embed/GAGJAI6CY64" title="「抖音」写了篆书才知篆书有多美啊！" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
🚩借鉴美国电脑发展历史，Fortran（Formula Translation的简称，公式翻译编程语言）与曦编程语言历史，会将目前的曦语言翻译并改良，使用咱们公元前的李斯篆书「文言文」文言计数编程并研发咱们「大秦赋算筹」。

- [「猫城」🚩🔆🏹🌟👊🚀🦔大秦赋：「世袭制道教自然对数进制大秦赋算筹」取代所有西方，包括阿拉伯数字和回教徒语言（包括巫术、货币、习俗文化、可兰经断肢法）、基督耶稣洋番（包括耶稣纪年法、货币、习俗文化、耶稣受难日、头戴白色老嬷嬷假发的基督洋番同性恋司法） #12](https://github.com/englianhu/zhongkehongqi/issues/12)
- [「博客园」自然常数e的由来以及计算机为什么是二进制](https://www.cnblogs.com/elliotchenzichang/p/16293757.html)
...
<iframe width="400" height="225" src="https://youtube.com/embed/j-YFB_HTt2s" title="数学帝国始皇帝 - 炎黄子孙" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

*出处：[「油管」瓜雪RHU花园加德士油站隔壁第三巷门牌卅二号的土司乩童世袭制法家刘氏彭城堂瑾貹/美国伐木的国父法官瓦盛顿/印度国父宗教司甘地/《魔戒三部曲》咕噜/时光机器二零零二白骨精](https://youtu.be/j-YFB_HTt2s)*

<iframe width="400" height="225" src="https://youtube.com/embed/auPaUFDYuBc" title="数学剑法 - 独孤九剑" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
在香港中信集团投资下的特里必斯公司，在FSBM大厦四楼投资百万建立<ruby>蹴<rp>(</rp><rt>cù</rt><rp>)</rp>鞠<rp>(</rp><rt>jū</rt><rp>)</rp></ruby>彩券核心业务操盘的盘房，而西施康就在二楼。在特里必斯工作还没两三个月，就开办了一个跟单与出货对冲部门、一个运筹帷幄部门，有个长相似台湾艺人曾国城（平时他喜欢自像台湾艺人NONO）的运筹帷幄部门主管名叫Kenny和长相似港星魏骏杰名叫阿文是同乡并认识的加影人、一个一九八零年出生洋名叫Rio（雷欧，那么巧合与我在二零零八年在西施康Ryo[^7](https://rpubs.com/englianhu/ryo-cn)]一样发音不同文字）而微软聊天软件匿名Rio Rex长相似苏丽欣的先生郭汉峰的则是咱们运筹帷幄部门组长上司，Rio性格温和只要没有被投诉就过着安逸的工作生活。有天同事兼室友阿文（长相似港星魏骏杰）聊起：“听讲二楼好似也有间博彩公司同行，不过是一家鬼佬公司，听说仅系接听电话同投注，非常安逸悠闲似卜基仔，不似我地后台仲需要看盘同操盘。听讲好似系🇬🇧英国立博🚩或伟徳或日博。”

[^7]: 2008年加入西世康首周培训时，培训师Tan Tee Wei(谐音：陈蒂薇)问我怎么称呼，有没有昵名之类的，然后想了几天后就自诩Ryo，就因为小学中学时期喜欢《街头霸王》的<ruby>龍<rp>(</rp><rt>りゅう</rt><rp>)</rp></ruby>（龙 Ryu）和升龙拳、《拳王》的<ruby>草<rp>(</rp><rt>くさ</rt><rp>)</rp>薙<rp>(</rp><rt>なぎ</rt><rp>)</rp>京<rp>(</rp><rt>きょう</rt><rp>)</rp></ruby>（京 Kyo），因为“<ruby>拾<rp>(</rp><rt>🇹🇼闽曰：khioh</rt><rp>)</rp></ruby>”字感觉像“拾金不昧”、“遭人嫌弃的养子”、“不是亲生的养子”（1983年出生的四哥联丰婴儿时期，家慈李仁曾送与大姨妈李英当儿子，祖母颜为得知赶紧到外祖母家载孙子回家。后来小姨妈李美兰花钱八千元马币为大姨妈买了个一九八八年出生的印度裔婴儿当儿子。而小时候90年代追《包青天》有集“狸猫换太子”）；[*就不想用Ryu和Kyo，联合起来自诩Ryo*]{style="color:#F6A217"}，刚好就和《拳王》（最初出现于一九九二年《龍虎の拳》的角色）中的<ruby>坂<rp>(</rp><rt>さか</rt><rp>)</rp>崎<rp>(</rp><rt>ざき</rt><rp>)</rp>亮<rp>(</rp><rt>りょう</rt><rp>)</rp></ruby>Ryo命名（绝技“真・天地覇煌拳”以速度取胜，不过最喜欢豪鬼的“瞬狱杀”，类似目前科研的高频量化交易），Ryo朗朗上口，记得西世康Jason问过Ryo中文怎么写，而我浅笑回答可以自定义为“良”、“量”、“亮”等汉字而故意不定位，不使用中文汉字，而使用外来语リョウ，一九九七年想学佐治.索罗斯当个金融业大玩家，当时完全没听说过任何量化圈的人物，二零零五年在赫萨贸易工作时只知道老外很厉害使用电脑编程和数学和统计学交易挣钱却没导师无从学起，甚至不晓得俗称“量化”，只知道以数学和统计学在交易市场挣钱。<br><br>二零一九年到乐发阿里彩票工作时，公司只允许使用别名，表格上本想用“<ruby>叡<rp>(</rp><rt>ruì</rt><rp>)</rp></ruby>欧”却忘了曹叡的叡字怎么写（就“叡”字少见，不过想到司马掌权就不使用“叡”字）、然后“磊欧”（为人“光明磊落”、“明人不做暗事”之意，正合个人的为人处事。从Caspo辞职回国就是立志学好在拉曼学院修读大学时所知道的统计学以数据的多寡加上统计建模在交易市场上挣钱，俗称**棣逊与克尔斯（一九九七・英）**提及的“大数定律”与“极大似然估计”，而非二零零六年在🇸🇬新加坡喜来登和嚣张🇸🇬欧阳金泰面试时夸夸其谈。二零零八年至二零一二年在西世康工作一心只想科研数学、建立量化避险基金，不靠奉承；有天光头上司麦克・卡特・克里斯多费尔・殡・阿杜拉欲提拔邀出席公司年宴当面，被我拒绝难堪后当面不知所措心慌。）不能朗朗上口、而“龙”字太普遍，然后就使用“雷欧”（考量到《飞跃青春》的王雷、🇸🇬新加坡行动党⚡️、🇪🇺欧盟、最主要是同是量化避险基金“雷达利欧”简称为“雷欧”）翻译原本的Ryo，然后同组有位“娟娟”（🇸🇬欧阳金泰妻子名叫“晓娟”）、“大龙”、“雷着”（2012年在马电讯工作过滤海外转播节目有出戏叫《飞跃情春》由长得像🇸🇬欧阳金泰的🇨🇳中国艺人王雷饰演，男主角的结局是悲情枪决死刑），和华财一样超短光头发型的雷着身份证姓名：王雷。“瑞欧”则是目前不速之客🇸🇪瑞典国鸟乌鸦时常飞来而命名。<br><br>2007年到🇸🇬新加坡喜来登酒店大厅面试Caspo新宝工作时，欧阳金泰和欧阳金喜俩问:“有没有一个比较容易记的名字、称号或别名？”，当时回复：“没有!”，然后在Caspo工作时，同事上司老板们都称“Lian Hu”。<br><br>*详情请查阅：[「鄀客栈」雷欧∪瑞欧，黄联富](https://rpubs.com/englianhu/ryo-cn)]*
...
借鉴愚生赢家黄氏江夏堂联富在二零零二年时期再拉曼学院修读电脑科学A流派专攻计数/机数系有个好哥儿们潮州人谢德才同学（长相似比尔盖茨斯斯文文戴副眼镜，而另一个长相似目前世界首富兼科学家艾隆∙马斯克的砂捞越富家公子福州人，名叫Wong Lee Hui不晓得是姓王或黄，名李辉，而我一九八八年出生的妹妹莲霜以前就喜欢威威组合——李威和林佑威中的李威。），当时我追求课外家庭日语班潮州人女同学艳迎（突然辍学转校到澳洲墨尔本大学进修时尚服装设计）失恋后，愚生在拉曼学院图书馆翻阅中国史书时中所提及的「卫鞅仕秦」[^8]时爱不释手、孜孜不倦、阅读到晚上图书馆大约九点钟左右打烊才离席回家，引用卫鞅在中国河南省云梦山鬼谷子旗下修炼帝王之术（文中提及卫鞅游说魏国联合其它五国联盟伐秦不果，就干脆投奔秦国灭六国联军，公元前的三顾茅驴对秦孝公——赢渠梁游说，推荐比公元后的《出师表》来得厉害的《商君书》阐明“帝道”、“王道”和“霸道”如何协助秦国稳扎稳打、百战百胜、直到一统天下，史称「商鞅变法」。结果秦国如实从秦孝公赢渠梁开始实践「商鞅变法」大约皕余年至秦王赢政一统天下，史称「秦始皇」。）如何驾驭权贵直到一统天下。

[^8]: 公元前（基督教和耶稣尚未出生在世上，春秋战国只有山东孔子的儒学）的卫国卫鞅仕秦、卫国吕不韦仕秦、楚国李斯仕秦，西方医学界都是使用🇨🇭（首府苏黎世）十字架符号或🇲🇻湾月符号。<br>公元后汉史《明修栈道》、《出师表》和公元后明史《烧饼歌》、《靖难之变》:<br> - *[「猫城」Pandoc based Quarto应该翻译成什么？ #三](https://github.com/scibrokes/r-world/issues/3#issue-1618233383)*<br> - *[「猫城」GitHub Repository 应该翻译成什么？#二](https://github.com/scibrokes/r-world/issues/2#issuecomment-1264570739)*

借鉴马来西亚国旗左🌜右🌠与「朕」字，赢政生于公元前农历XXX年属虎，过林之虎🐯而孙文生于公元后农历XXX年也属虎，山林之虎🐯。借鉴千年可兰经回教刑事法典断肢法阐明世袭制可兰经法家回教徒教唆、诬蔑、盗窃（身份、包括角色扮演）等，在婚前通奸得判鞭刑，而吴越春秋中的楚国秦人伍子胥掘坟鞭尸后投靠吴国~

- [秦始皇為何自稱「朕」？把「朕」字拆開來看看，原來大有內涵](https://m.facebook.com/story.php?story_fbid=pfbid02q9h8U3Yz3J7BBSFJHUWiqdCdjyPmpQPeoQ34w4t9qndCrXKBim7RcvTLU86ZcsC8l&id=100075729026612&mibextid=Nif5oz)，「朕」日语发音为Chin。
- [公元前五一四 丁亥年🦔 阖闾登基][https://m.cidianwang.com/nianhao/chunqiu_ebdf2_12.htm)、九十年代时期的港剧「大时代」中饰演丁蟹🦀（秋官 郑少秋饰演金融业商业大亨）；而「万年历」中的年份从公元后一八二八年开始到二一二八年一共三百年，一八二八年一月八日美国建立民主党而年底十二月大选第一任民主党候选人安德鲁•杰克逊当选美国总统。同年，俄国沙皇帝国于希腊独立战争趁火打劫，爆发第八次俄土战争。从公元前五一四 🦔丁亥年计算起的一百九十六年后是[「百度百科」公元前三一八 甲辰年](https://baike.baidu.com/item/%E5%85%AC%E5%85%83%E5%89%8D318%E5%B9%B4/6079335)五国纵秦和屈原廿五岁仕楚，而[「维基百科」公元后一八二八 🦔丁亥年](https://zh.m.wikipedia.org/zh-my/1828%E5%B9%B4)计算起的一百九十六年后是今年是公元后二零二四 甲辰年，咱们亚洲🌏货币贬值许多而目前下半年出现好转。借鉴李斯是湖内之牛而一九四九 己丑年栏内之牛海外华人公会🌠立党、同年先慈李仁Lee Jin生忌与🇨🇳中国十月一日立国，🦔丁亥年与高频量化对冲基金Hedgehogs刺猬豪猪 四太子朱棣。
- 
...
阳历二零零八年加入西施康后，由于每天都很清闲，过着安逸的生活。工作时间从周一至周五，每天轮班制有三班如下：
...
阳历二零零八年三月到二零一二年七月四年有余，如同在学院或大学修读时期一样安逸悠闲。每天上班时间都在上网浏览并搜索各种计数/机数软件和任何<ruby>蹴<rp>(</rp><rt>cù</rt><rp>)</rp>鞠<rp>(</rp><rt>jū</rt><rp>)</rp></ruby>彩券计数/机数建模科研文献，当时市场上并没有任何普遍通行的计数/机数软件，在搜索和浏览并参与许多论坛后，经常混：
...
借鉴咱们秦人（赢家黄氏江夏堂，目前均以「江夏」，它日根据量子数据库中心筹算民生、民意、钱谷、人均、各行各业、万家灯火、士农工商等各数据指数，再改国号、堂号、路线，直到秦统天下）牧马至秦灭六国，一统天下历史：
- 周朝：秦人牧马
- 周朝：马陵之战
- 周末：秦灭六国
- 周末：楚虽三户，亡秦必楚
...
- 隋朝：秦王唐朝
- 元末：明汉相争
- 马国：土司相争（秦人牧马，土司乩童白骨精刘瑾貹和名嘴巫师王张佳坤 - 刘张之争）

`eval(parse(text = 参数))`可以诠释为**评估绩效（奉常旗下的各种族各宗教各自监督执法（司法院立法 = 多元法律））**先将函数文字化，再通过文本分析来执行任务，几乎可以运行筹算任何R鄀语言统计编程代码，[**knitr🧶**：Chunk options and package options](https://yihui.org/knitr/options)也是通过辨认各代码篆标题文本分析。那些回教徒只需要遵守可兰经回教刑事法典习俗文化宗教语言断肢法、而兴都教徒则遵守《吠陀经》大宝森节和屠妖节习俗文化宗教语言法律即可。
...
<iframe width="400" height="225" src="https://youtube.com/embed/roq7hcgVTqk" title="了解 Popularity of R Programming 作为一种编程语言的流行度（四分钟微学习）ENG Subtitle" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

*出处：[「油管」瓜雪RHU花园加德士油站隔壁第三巷门牌卅二号的土司乩童世袭制法家刘氏彭城堂瑾貹/美国伐木的国父法官瓦盛顿/印度国父宗教司甘地/《魔戒三部曲》咕噜/时光机器二零零二白骨精](https://youtu.be/roq7hcgVTgk)*

*一九九四年澳洲Ross & Robert研发鄀统计编程语言。*

- [「七龍珠總整理」所有的RR人造人 | 一次看完壹至廿壹號人造人 以及那些你可能沒看過的人造人 | 人造人九號、十七與十八號合體、人造人八千號？！](https://youtu.be/_yD7IZYnIUU)

- [五分鐘鄀語言系列](https://youtube.com/playlist?list=PLghWJf3e_h2GMPHNGbT4TN-kdfEvQgmPu)
- [鄀語言大數據](https://youtube.com/playlist?list=PLxYedd0OW1Pw4smFm9KcWP77v1HBZUBAg)
- [鄀语言数据可视化实战——大数据专业图表从入门到精通（微视频全解版）](https://youtube.com/playlist?list=PL5jFwqTxh71a9XfKuO3wKB2XsNOqHaxds)
...
<iframe width="400" height="225" src="https://youtube.com/embed/ONtyQcRsaUw" title="「空城计」MY大汉山世袭制法家可兰经回教刑事法典习俗文化宗教语言断肢法巫贼巫婆非法回教徒巫术份子和赤印度人酋长宗教司甘地/土司乩童刘瑾貹和世袭制法家可兰经回教刑事法典习俗文化宗教语言断肢法巫贼巫婆非法回教徒巫术份子 -自杀式恐怖袭击- 红军🚩" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
《商君书》之“帝道”、“王道”、“霸道”为咱们秦国奠定一个一统天下的稳定基础，直到世袭制道教徒秦王赢政（十二生肖、姓氏堂号子嗣贞节牌坊）的功勋超越历代三黄五帝，史称秦始皇。
...
> 
> - 🚩🌟🦔赢家黄氏江夏堂，黄河文明、黄埔军校、黄种人赢政之黄河文明拯救亚洲人，焚经坑乌（歼灭所有可兰经回教刑事法典断肢法的回教徒和吠陀经大宝森节屠妖节习俗文化的兴都教徒），功勋超过历代三黄五帝，建立道家、物理学、统筹法、运筹学、学术、金融、军事、易经、算卜、天文历法、夜观星象、风水学、概率论与博弈论、黄种人世袭制道家民族主义，史称「秦始皇」
> 
...
- 子鼠
   - 甲子（屋上之鼠/木鼠）：愚生赢家黄氏江夏堂联富（农历一九八四年九月廿八）
   - 庾子（仓内之鼠/金鼠）：先贤明成祖朱棣（农历一三六零年）
   - 壬子（山上之鼠/水鼠）：先贤美国国父佐治•瓦圣盾（农历）
- 丑牛
   - 丁丑（湖内之牛/火牛）：先贤长史秦相李斯/李通古
   - 己丑（栏内之牛/土牛）：先贤法国革命家拿破仑（农历一九四九年）
   - 己丑（栏内之牛/土牛）：先慈李氏陇西堂仁（农历一九四九年）
- 寅虎
   - 甲寅（立定之虎/木虎）：大姐赢家黄氏江夏堂莲碧（农历一九七四年）
   - 丙寅（山林之虎/火虎）：先贤中华民国国父孙中山/孙逸仙/孙文
   - 壬寅（过林之虎/水虎）：先贤赢政（农历公元前二五九年）
   - 犯太岁，拜虎爷。[「太歲」是什麼？中國科學家用精密儀器，揭開「太歲」的秘密](https://comeworlds.com/doc_UHhuUllMVDVSUDRxQ2Rid3RDNy9qUT09?su=63316009#hkzcy)
- 卯兔
   - 
- 辰龙
   - 丙辰（天上之龙/火龙）：二姐赢家黄氏江夏堂莲厉（农历一九七六年）
   - 戊辰（温情之龙/土龙）：妹妹赢家黄氏江夏堂莲霜（农历一九八八年）
   - 庾辰（怒性之龙/金龙）：先贤赢异人/赢子楚（农历公元前二八一年）
- 巳蛇
   - 乙巳（出穴之蛇/木蛇）：先贤汉高祖刘邦（农历公元前二五六年三月初三）
   - 己巳（福气之蛇/土蛇）：先贤西楚霸王项羽（农历公元前二三二年）
   - 丁巳（塘内之蛇/火蛇）：三姐赢家黄氏江夏堂莲真（农历一九七七年）
   - 癸巳（草中之蛇/水蛇）：先贤中国国父毛泽东（农历一八九三年十一月十九）
   - 癸巳（草中之蛇/水蛇）：GNU牛羚创始人李查•马修•斯托曼（农历一九五三年二月初二）。春秋战国时期的齐国，稷下学宫的劝学堂大厅挂着一个牛头。
- 午马
   - 戊午（厩内之马/土马）：大哥赢家黄氏江夏堂联升（农历一九七八年）
- 未羊
   - 乙未（敬重之羊/木羊）：比尔•威廉•盖茨（农历一九五五年九月十三）
   - 乙未（敬重之羊/木羊）：斯蒂芬•保罗•乔布斯（农历一九五五年一月廿二）
   - 辛未（得禄之羊/金羊）：弟弟赢家黄氏江夏堂联巡（农历一九九一年）
- 申猴
   - 甲申（过树之猴/木猴）：家父赢家黄氏江夏堂永隆/永春，赢政 ξηg Tεηg（农历一九四四年）
   - 庾申（食果之猴/金猴）：二哥赢家黄氏江夏堂联旗（农历一九八零年）
- 酉鸡
   - 辛酉（龙藏之鸡/金鸡）灵婴耶稣临盆（农历公元元年）
   - 辛酉（龙藏之鸡/金鸡）：三哥赢家黄氏江夏堂联山（农历一九八一年）
- 亥猪
   - 丁亥（过山之猪/火猪）：中华民国三军统帅蒋中正/蒋介石（农历一八八七年九月十五）
   - 丁亥（过山之猪/火猪）：美国民主党创党者兼第一任主席安德鲁∙杰克逊当选美国第七任总统（农历一七六七年二月十六）
   - 癸亥（林下之猪/水猪）：四哥赢家黄氏江夏堂联丰（农历一九八三年）

欲知名人生肖，可查阅[<span style='color:#DE5D83; background-color:black;'>金融衍生</span> - 筛选日内高频量化交易计数模型 <span style='color:#4E79A7'>**第三部∙乙（春秋战国《晏子春秋》——总结平滑指数尤物）](https://englianhu.github.io/民国一百一十三年（甲辰年）/寒月/binary-Q1Inter-HFT-RV3E.html#22123_万年历)，由于数据仅以阳历年份转化为咱们黄历/农历，故此生肖会有落差。倘若它日欲出版咱们世袭制道教徒赢家黄氏江夏堂十二生肖秦人黄埔军校黄种人的《黄历》，需要建立超级电脑以文言计数编程筹算、占卜... 欲知更多详情，请查阅[附录](#附录)。
...
- 秦人牧马，秦国烈日当空的壬寅年出生生肖老虎的赢政，在公元前秦灭六国皕廿一庾辰年登基，史称“秦始皇”。
...
#### 辰龙（秦庄襄王赢异人与赵姬、成龙与娱乐圈）

- [峇东新村和地标《南天宫》盘古庙宇](#峇东新村和地标《南天宫》盘古庙宇)
- ，请查阅[名人](#名人)。

#### 未羊仕秦

- 卫鞅仕秦。
- 未羊年出生的比尔盖茨、斯蒂芬乔布斯，请查阅[名人](#名人)。
...
*注释：它日将翻译并改良现有的所有资源，如`forecast()`和`predict()`都翻译为占卜（动词），而`forecast`程序包则译为算卜（名词）。*
