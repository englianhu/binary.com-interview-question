...
- If first ask price hit `r s.fct.Lo`, buy order limit open transaction.
...
- If first bid price hit `r s.fct.Hi`, sell order limit open transaction.
...
04. [The Kelly Criterion and the Stock Market](The Kelly Criterion and the Stock Market.pdf)
05. [Beat the Market - A Scientific Stock Market System](Beat the Market - A Scientific Stock Market System.pdf)
