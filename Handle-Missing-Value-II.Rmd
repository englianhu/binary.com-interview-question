...
Y2015W1_m1 <- llply(fls, function(x) {
    readRDS(paste0(pth, x))
  }) %>% bind_rows
...
```{r warning=FALSE}
Y2015W1_m1_NA <- Y2015W1_m1 %>% 
  dplyr::select(index, BidOpen, BidHigh, BidLow, BidClose, 
                AskOpen, AskHigh, AskLow,  AskClose) %>% 
  prodNA(noNA = 0.01)

Y2015W1_m1_1_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_m1_1_impTS) <- algo
Y2015W1_m1_1_impTS %<>% ldply %>% tbl_df

Y2015W1_m1_1_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_m1_NA <- Y2015W1_m1 %>% 
  dplyr::select(BidOpen, BidHigh, BidLow, BidClose, 
                AskOpen, AskHigh, AskLow,  AskClose) %>% 
  prodNA(noNA = 0.01) %>% 
  cbind(Y2015W1_m1[1], .) %>% tbl_df

Y2015W1_m1_1_amelia <- Y2015W1_m1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_m1_1_amelia %>% anyNA

Y2015W1_m1_1_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_m1_1_tidyr <- Y2015W1_m1_NA %>% 
...
Y2015W1_m1_1_tidyr %>% anyNA

Y2015W1_m1_1_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_tm1_1_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_tm1_1_impTS) <- algo
Y2015W1_tm1_1_impTS %<>% ldply %>% tbl_df

Y2015W1_tm1_1_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_tm1_NA <- Y2015W1_tm1 %>% 
  dplyr::select(BidOpen, BidHigh, BidLow, BidClose, 
                AskOpen, AskHigh, AskLow,  AskClose) %>% 
  prodNA(noNA = 0.01) %>% 
  cbind(Y2015W1_tm1[1], .) %>% tbl_df

Y2015W1_tm1_1_amelia <- Y2015W1_tm1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_tm1_1_amelia %>% anyNA

Y2015W1_tm1_1_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_1_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_1_tidyr <- Y2015W1_tm1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_tm1_1_tidyr %>% anyNA

Y2015W1_tm1_1_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_m1_10_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_m1_10_impTS) <- algo
Y2015W1_m1_10_impTS %<>% ldply %>% tbl_df

Y2015W1_m1_10_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_m1_10_amelia <- Y2015W1_m1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_m1_10_amelia %>% anyNA

Y2015W1_m1_10_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_m1_10_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_10_tidyr <- Y2015W1_m1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_m1_10_tidyr %>% anyNA

Y2015W1_m1_10_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_tm1_10_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_tm1_10_impTS) <- algo
Y2015W1_tm1_10_impTS %<>% ldply %>% tbl_df

Y2015W1_tm1_10_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_10_impTS %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_10_amelia <- Y2015W1_tm1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_tm1_10_amelia %>% anyNA

Y2015W1_tm1_10_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_10_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_10_tidyr <- Y2015W1_tm1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_tm1_10_tidyr %>% anyNA

Y2015W1_tm1_10_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_10_tidyr %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_20_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_m1_20_impTS) <- algo
Y2015W1_m1_20_impTS %<>% ldply %>% tbl_df

Y2015W1_m1_20_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_m1_20_amelia <- Y2015W1_m1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_m1_20_amelia %>% anyNA

Y2015W1_m1_20_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_m1_20_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_20_tidyr <- Y2015W1_m1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_m1_20_tidyr %>% anyNA

Y2015W1_m1_20_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_tm1_20_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_tm1_20_impTS) <- algo
Y2015W1_tm1_20_impTS %<>% ldply %>% tbl_df

Y2015W1_tm1_20_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_20_impTS %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_20_amelia <- Y2015W1_tm1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_tm1_20_amelia %>% anyNA

Y2015W1_tm1_20_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_20_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_20_tidyr <- Y2015W1_tm1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_tm1_20_tidyr %>% anyNA

Y2015W1_tm1_20_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_20_tidyr %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_30_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_m1_30_impTS) <- algo
Y2015W1_m1_30_impTS %<>% ldply %>% tbl_df

Y2015W1_m1_30_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_m1_30_amelia <- Y2015W1_m1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_m1_30_amelia %>% anyNA

Y2015W1_m1_30_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_m1_30_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_30_tidyr <- Y2015W1_m1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_m1_30_tidyr %>% anyNA

Y2015W1_m1_30_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_tm1_30_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_tm1_30_impTS) <- algo
Y2015W1_tm1_30_impTS %<>% ldply %>% tbl_df

Y2015W1_tm1_30_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_30_impTS %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_30_amelia <- Y2015W1_tm1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_tm1_30_amelia %>% anyNA

Y2015W1_tm1_30_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_30_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_30_tidyr <- Y2015W1_tm1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_tm1_30_tidyr %>% anyNA

Y2015W1_tm1_30_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_30_tidyr %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_50_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_m1_50_impTS) <- algo
Y2015W1_m1_50_impTS %<>% ldply %>% tbl_df

Y2015W1_m1_50_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_m1_50_amelia <- Y2015W1_m1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_m1_50_amelia %>% anyNA

Y2015W1_m1_50_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_m1_50_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_50_tidyr <- Y2015W1_m1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_m1_50_tidyr %>% anyNA

Y2015W1_m1_50_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_tm1_50_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_tm1_50_impTS) <- algo
Y2015W1_tm1_50_impTS %<>% ldply %>% tbl_df

Y2015W1_tm1_50_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_50_impTS %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_50_amelia <- Y2015W1_tm1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_tm1_50_amelia %>% anyNA

Y2015W1_tm1_50_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_50_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_50_tidyr <- Y2015W1_tm1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_tm1_50_tidyr %>% anyNA

Y2015W1_tm1_50_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_50_tidyr %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_65_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_m1_65_impTS) <- algo
Y2015W1_m1_65_impTS %<>% ldply %>% tbl_df

Y2015W1_m1_65_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_m1_65_amelia <- Y2015W1_m1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_m1_65_amelia %>% anyNA

Y2015W1_m1_65_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_m1_65_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_65_tidyr <- Y2015W1_m1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_m1_65_tidyr %>% anyNA

Y2015W1_m1_65_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_tm1_65_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_tm1_65_impTS) <- algo
Y2015W1_tm1_65_impTS %<>% ldply %>% tbl_df

Y2015W1_tm1_65_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_65_impTS %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_65_amelia <- Y2015W1_tm1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_tm1_65_amelia %>% anyNA

Y2015W1_tm1_65_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_65_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_65_tidyr <- Y2015W1_tm1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_tm1_65_tidyr %>% anyNA

Y2015W1_tm1_65_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_65_tidyr %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_70_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_m1_70_impTS) <- algo
Y2015W1_m1_70_impTS %<>% ldply %>% tbl_df

Y2015W1_m1_70_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_m1_70_amelia <- Y2015W1_m1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_m1_70_amelia %>% anyNA

Y2015W1_m1_70_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_m1_70_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_70_tidyr <- Y2015W1_m1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_m1_70_tidyr %>% anyNA

Y2015W1_m1_70_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_tm1_70_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_tm1_70_impTS) <- algo
Y2015W1_tm1_70_impTS %<>% ldply %>% tbl_df

Y2015W1_tm1_70_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_70_impTS %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_70_amelia <- Y2015W1_tm1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_tm1_70_amelia %>% anyNA

Y2015W1_tm1_70_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_70_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_70_tidyr <- Y2015W1_tm1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_tm1_70_tidyr %>% anyNA

Y2015W1_tm1_70_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_70_tidyr %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_80_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_m1_80_impTS) <- algo
Y2015W1_m1_80_impTS %<>% ldply %>% tbl_df

Y2015W1_m1_80_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_m1_80_amelia <- Y2015W1_m1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_m1_80_amelia %>% anyNA

Y2015W1_m1_80_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_m1_80_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_80_tidyr <- Y2015W1_m1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_m1_80_tidyr %>% anyNA

Y2015W1_m1_80_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_tm1_80_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_tm1_80_impTS) <- algo
Y2015W1_tm1_80_impTS %<>% ldply %>% tbl_df

Y2015W1_tm1_80_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_80_impTS %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_80_amelia <- Y2015W1_tm1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_tm1_80_amelia %>% anyNA

Y2015W1_tm1_80_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_80_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_80_tidyr <- Y2015W1_tm1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_tm1_80_tidyr %>% anyNA

Y2015W1_tm1_80_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_80_tidyr %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_85_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_m1_85_impTS) <- algo
Y2015W1_m1_85_impTS %<>% ldply %>% tbl_df

Y2015W1_m1_85_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_m1_85_amelia <- Y2015W1_m1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_m1_85_amelia %>% anyNA

Y2015W1_m1_85_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_m1_85_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_85_tidyr <- Y2015W1_m1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_m1_85_tidyr %>% anyNA

Y2015W1_m1_85_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_tm1_85_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_tm1_85_impTS) <- algo
Y2015W1_tm1_85_impTS %<>% ldply %>% tbl_df

Y2015W1_tm1_85_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_85_impTS %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_85_amelia <- Y2015W1_tm1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_tm1_85_amelia %>% anyNA

Y2015W1_tm1_85_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_85_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_85_tidyr <- Y2015W1_tm1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_tm1_85_tidyr %>% anyNA

Y2015W1_tm1_85_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_85_tidyr %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_90_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_m1_90_impTS) <- algo
Y2015W1_m1_90_impTS %<>% ldply %>% tbl_df

Y2015W1_m1_90_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_m1_90_amelia <- Y2015W1_m1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_m1_90_amelia %>% anyNA

Y2015W1_m1_90_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_m1_90_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_m1_90_tidyr <- Y2015W1_m1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_m1_90_tidyr %>% anyNA

Y2015W1_m1_90_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))
...
Y2015W1_tm1_90_impTS <- llply(algo, function(x) {
  Y2015W1_m1_NA %>% 
    dplyr::select(starts_with('Ask'), starts_with('Bid')) %>% 
    map(na.seadec, algorithm = x) %>% as.tibble
  })
names(Y2015W1_tm1_90_impTS) <- algo
Y2015W1_tm1_90_impTS %<>% ldply %>% tbl_df

Y2015W1_tm1_90_impTS %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_90_impTS %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_90_amelia <- Y2015W1_tm1_NA %>% 
  amelia %>% 
  .$imputations %>% 
  ldply %>% tbl_df

Y2015W1_tm1_90_amelia %>% anyNA

Y2015W1_tm1_90_amelia %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_90_amelia %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
Y2015W1_tm1_90_tidyr <- Y2015W1_tm1_NA %>% 
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose) %>% #default direction down
  fill(BidOpen, BidHigh, BidLow, BidClose, 
       AskOpen, AskHigh, AskLow, AskClose, .direction = 'up')

Y2015W1_tm1_90_tidyr %>% anyNA

Y2015W1_tm1_90_tidyr %<>% mutate(
  bias.open = if_else(AskOpen>AskHigh|AskOpen<AskLow, 1, 0), 
  bias.high = if_else(AskHigh<AskOpen|AskHigh<AskLow|AskHigh<AskClose, 1, 0), 
  bias.low = if_else(AskLow>AskOpen|AskLow>AskHigh|AskLow>AskClose, 1, 0), 
  bias.close = if_else(AskClose>AskHigh|AskClose<AskLow, 1, 0))

Y2015W1_tm1_90_tidyr %>% 
  dplyr::filter(bias.open==1|bias.high==1|bias.low==1|bias.close==1)
...
```{r warning=FALSE}
dfm1_impTS <- list(`1%` = Y2015W1_m1_1_impTS, `10%` = Y2015W1_m1_10_impTS, 
                   `20%` = Y2015W1_m1_20_impTS, `30%` = Y2015W1_m1_30_impTS, 
                   `50%` = Y2015W1_m1_50_impTS, `65%` = Y2015W1_m1_65_impTS, 
                   `70%` = Y2015W1_m1_70_impTS, `80%` = Y2015W1_m1_80_impTS, 
                   `85%` = Y2015W1_m1_85_impTS, `90%` = Y2015W1_m1_90_impTS)

dfm2_impTS <- list(`1%` = Y2015W1_tm1_1_impTS, `10%` = Y2015W1_tm1_10_impTS, 
                   `20%` = Y2015W1_tm1_20_impTS, `30%` = Y2015W1_tm1_30_impTS, 
                   `50%` = Y2015W1_tm1_50_impTS, `65%` = Y2015W1_tm1_65_impTS, 
                   `70%` = Y2015W1_tm1_70_impTS, `80%` = Y2015W1_tm1_80_impTS, 
                   `85%` = Y2015W1_tm1_85_impTS, `90%` = Y2015W1_tm1_90_impTS)
...
```{r warning=FALSE}
dfm1_amelia <- list(`1%` = Y2015W1_m1_1_amelia, `10%` = Y2015W1_m1_10_amelia, 
                    `20%` = Y2015W1_m1_20_amelia, `30%` = Y2015W1_m1_30_amelia, 
                    `50%` = Y2015W1_m1_50_amelia, `65%` = Y2015W1_m1_65_amelia, 
                    `70%` = Y2015W1_m1_70_amelia, `80%` = Y2015W1_m1_80_amelia, 
                    `85%` = Y2015W1_m1_85_amelia, `90%` = Y2015W1_m1_90_amelia)

dfm2_amelia <- list(`1%` = Y2015W1_tm1_1_amelia, `10%` = Y2015W1_tm1_10_amelia, 
                    `20%` = Y2015W1_tm1_20_amelia, `30%` = Y2015W1_tm1_30_amelia, 
                    `50%` = Y2015W1_tm1_50_amelia, `65%` = Y2015W1_tm1_65_amelia, 
                    `70%` = Y2015W1_tm1_70_amelia, `80%` = Y2015W1_tm1_80_amelia, 
                    `85%` = Y2015W1_tm1_85_amelia, `90%` = Y2015W1_tm1_90_amelia)
...
```{r warning=FALSE}
dfm1_tidyr <- list(`1%` = Y2015W1_m1_1_tidyr, `10%` = Y2015W1_m1_10_tidyr, 
                   `20%` = Y2015W1_m1_20_tidyr, `30%` = Y2015W1_m1_30_tidyr, 
                   `50%` = Y2015W1_m1_50_tidyr, `65%` = Y2015W1_m1_65_tidyr, 
                   `70%` = Y2015W1_m1_70_tidyr, `80%` = Y2015W1_m1_80_tidyr, 
                   `85%` = Y2015W1_m1_85_tidyr, `90%` = Y2015W1_m1_90_tidyr)

dfm2_tidyr <- list(`1%` = Y2015W1_tm1_1_tidyr, `10%` = Y2015W1_tm1_10_tidyr, 
                   `20%` = Y2015W1_tm1_20_tidyr, `30%` = Y2015W1_tm1_30_tidyr, 
                   `50%` = Y2015W1_tm1_50_tidyr, `65%` = Y2015W1_tm1_65_tidyr, 
                   `70%` = Y2015W1_tm1_70_tidyr, `80%` = Y2015W1_tm1_80_tidyr, 
                   `85%` = Y2015W1_tm1_85_tidyr, `90%` = Y2015W1_tm1_90_tidyr)
